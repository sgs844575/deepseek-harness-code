window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-settings-plugins\src\client\fields.module.css.mjs
		const css$2 = ".EH87sq_field{flex-direction:column;gap:6px;padding:12px 0;display:flex}.EH87sq_field+.EH87sq_field{border-top:1px solid var(--dsw-alias-border-l2)}.EH87sq_head{align-items:center;gap:8px;display:flex}.EH87sq_label{min-width:0;color:var(--dsw-alias-label-primary);flex:1;font-size:13px;font-weight:500;line-height:1.5}.EH87sq_badges{align-items:center;gap:8px;display:inline-flex}.EH87sq_badge{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.EH87sq_badgeMuted{white-space:nowrap;color:var(--dsw-alias-label-tertiary);border-radius:999px;padding:1px 8px;font-size:11px;line-height:17px}.EH87sq_reset{font:inherit;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;padding:0;font-size:12px;line-height:1.5}.EH87sq_reset:hover:not(:disabled){color:var(--dsw-alias-label-primary)}.EH87sq_reset:disabled{cursor:default}.EH87sq_input{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);height:34px;font:inherit;color:var(--dsw-alias-label-primary);border-radius:8px;padding:0 12px;font-size:13px;line-height:1.5}.EH87sq_input:focus-visible{border-color:var(--dsw-alias-brand-primary);outline:none}.EH87sq_input:disabled{color:var(--dsw-alias-label-tertiary);cursor:default}.EH87sq_inputInvalid{border-color:var(--dsw-alias-label-error);}.EH87sq_invalid{color:var(--dsw-alias-label-error);margin:0;font-size:12px;line-height:1.5}.EH87sq_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}";
		...
		var fields_module_css_default = {
			...
			"hint": "EH87sq_hint",
			"input": "EH87sq_input",
			"inputInvalid": "EH87sq_inputInvalid",
			"invalid": "EH87sq_invalid",
			"head": "EH87sq_head",
			"reset": "EH87sq_reset",
			"badges": "EH87sq_badges",
			"label": "EH87sq_label",
			"badgeMuted": "EH87sq_badgeMuted",
			"badge": "EH87sq_badge"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-settings-plugins\src\client\PluginCard.module.css.mjs
		const css$1 = "._7JciAa_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}._7JciAa_card:hover{border-color:var(--dsw-alias-label-dimmed)}._7JciAa_cardOpen{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-dimmed)}._7JciAa_header{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}._7JciAa_header:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}._7JciAa_headText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}._7JciAa_name{color:var(--dsw-alias-label-primary);font-size:15px;font-weight:600;line-height:1.4}._7JciAa_description{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:1.5}._7JciAa_chevron{color:var(--dsw-alias-label-tertiary);flex:none;transition:transform .16s}._7JciAa_chevronOpen{transform:rotate(180deg)}._7JciAa_body{border-top:1px solid var(--dsw-alias-border-l2);margin:0 16px;padding-bottom:8px}._7JciAa_readOnly{color:var(--dsw-alias-label-tertiary);margin:12px 0 0;font-size:12px;line-height:1.5}._7JciAa_pending{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}._7JciAa_footer{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}._7JciAa_failed{min-width:0;color:var(--dsw-alias-label-error);flex:1;margin:0;font-size:12px;line-height:1.5}._7JciAa_discard,._7JciAa_save{appearance:none;font:inherit;cursor:pointer;border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}._7JciAa_discard{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}._7JciAa_discard:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}._7JciAa_save{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3)}._7JciAa_discard:disabled,._7JciAa_save:disabled{opacity:.4;cursor:default}._7JciAa_discard:focus-visible,._7JciAa_save:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}";
		...
		var PluginCard_module_css_default = {
			"card": "_7JciAa_card",
			"readOnly": "_7JciAa_readOnly",
			"failed": "_7JciAa_failed",
			"footer": "_7JciAa_footer",
			"header": "_7JciAa_header",
			"cardOpen": "_7JciAa_cardOpen",
			"chevronOpen": "_7JciAa_chevronOpen",
			"chevron": "_7JciAa_chevron",
			"name": "_7JciAa_name",
			"headText": "_7JciAa_headText",
			"description": "_7JciAa_description",
			"discard": "_7JciAa_discard",
			"pending": "_7JciAa_pending",
			"body": "_7JciAa_body",
			"save": "_7JciAa_save"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-settings-plugins\src\client\PluginsSettingsSection.module.css.mjs
		const css = ".Wo9hha_section{max-width:760px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.Wo9hha_heading{margin:0;font-size:18px;font-weight:600}.Wo9hha_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.Wo9hha_tabs{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:flex-end;gap:22px;margin-top:2px;display:flex}.Wo9hha_tab{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:0;padding:7px 1px 9px;font-size:13px;line-height:20px;position:relative}.Wo9hha_tab:hover,.Wo9hha_tab[data-active=true]{color:var(--dsw-alias-label-primary)}.Wo9hha_tab[data-active=true]:after,.Wo9hha_tab:focus-visible:after{background:var(--dsw-alias-label-primary);content:\"\";border-radius:2px 2px 0 0;height:2px;position:absolute;bottom:-1px;left:0;right:0}.Wo9hha_tab:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px;color:var(--dsw-alias-label-primary);border-radius:2px}.Wo9hha_panel{min-width:0;padding-top:2px}.Wo9hha_cards{flex-direction:column;gap:10px;margin:0;padding:0;list-style:none;display:flex}.Wo9hha_empty{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}";
		...
		var PluginsSettingsSection_module_css_default = {
			"tabs": "Wo9hha_tabs",
			"cards": "Wo9hha_cards",
			"heading": "Wo9hha_heading",
			"section": "Wo9hha_section",
			"empty": "Wo9hha_empty",
			"panel": "Wo9hha_panel",
			"intro": "Wo9hha_intro",
			"tab": "Wo9hha_tab"
