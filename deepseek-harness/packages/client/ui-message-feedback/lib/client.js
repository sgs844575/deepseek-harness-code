window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-message-feedback\src\client\MessageFeedbackActions.module.css.mjs
		const css = ".Oz2HMa_action{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:6px;display:inline-flex}.Oz2HMa_action:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.Oz2HMa_action:disabled{cursor:default;opacity:.4}.Oz2HMa_action[data-active]{color:var(--dsw-alias-label-primary)}.Oz2HMa_noteOpen{max-width:220px;color:var(--dsw-alias-label-tertiary);white-space:nowrap;text-overflow:ellipsis;cursor:pointer;background:0 0;border:none;border-radius:14px;padding:0 8px;font-size:13px;line-height:28px;overflow:hidden}.Oz2HMa_noteOpen:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.Oz2HMa_noteEditor{align-items:flex-start;gap:6px;display:inline-flex}.Oz2HMa_noteInput{border:1px solid var(--dsw-alias-border-secondary);background:var(--dsw-alias-bg-primary);width:260px;color:var(--dsw-alias-label-primary);font:inherit;resize:vertical;border-radius:8px;padding:6px 8px;font-size:13px}.Oz2HMa_noteSave,.Oz2HMa_noteCancel{cursor:pointer;border:none;border-radius:14px;height:28px;padding:0 10px;font-size:13px}.Oz2HMa_noteSave{background:var(--dsw-alias-interactive-bg-primary);color:var(--dsw-alias-label-inverse)}.Oz2HMa_noteSave:disabled{cursor:default;opacity:.4}.Oz2HMa_noteCancel{color:var(--dsw-alias-label-tertiary);background:0 0}.Oz2HMa_noteCancel:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.Oz2HMa_failure{color:var(--dsw-alias-label-tertiary);padding-left:4px;font-size:13px;line-height:28px}";
		...
		var MessageFeedbackActions_module_css_default = {
			"noteEditor": "Oz2HMa_noteEditor",
			"failure": "Oz2HMa_failure",
			"noteSave": "Oz2HMa_noteSave",
			"action": "Oz2HMa_action",
			"noteCancel": "Oz2HMa_noteCancel",
			"noteOpen": "Oz2HMa_noteOpen",
			"noteInput": "Oz2HMa_noteInput"
		};
		//#endregion
