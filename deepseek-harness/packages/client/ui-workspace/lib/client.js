window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-workspace\src\client\rows\Rows.module.css.mjs
		const css$2 = ".zx1M1a_projectRow,.zx1M1a_sessionRow{cursor:pointer;user-select:none;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex}.zx1M1a_projectRow:hover,.zx1M1a_sessionRow:hover,.zx1M1a_sessionRow.zx1M1a_selected{background:var(--dsw-alias-interactive-bg-hover)}.zx1M1a_searchResultRow{box-sizing:border-box;cursor:pointer;text-align:left;width:100%;min-height:48px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:8px;flex-direction:column;align-items:stretch;padding:4px 8px;display:flex}.zx1M1a_searchResultRow:hover,.zx1M1a_searchResultRow.zx1M1a_selected{background:var(--dsw-alias-interactive-bg-hover)}.zx1M1a_searchResultHeading{align-items:center;min-width:0;display:flex}.zx1M1a_searchResultTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;margin-left:4px;font-size:14px;line-height:20px;overflow:hidden}.zx1M1a_searchResultMeta{align-items:center;gap:6px;min-width:0;margin-left:20px;display:flex}.zx1M1a_searchResultWorkspace,.zx1M1a_searchResultSnippet{text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:17px;overflow:hidden}.zx1M1a_searchResultWorkspace{max-width:40%;color:var(--dsw-alias-label-tertiary);flex:none}.zx1M1a_searchResultSnippet{min-width:0;color:var(--dsw-alias-label-secondary);flex:1}.zx1M1a_projectRow{box-sizing:border-box;align-items:center;height:34px}.zx1M1a_projectRow .zx1M1a_rowActions{height:20px}.zx1M1a_sessionRow{height:32px;animation:zx1M1a_row-in .15s var(--ds-ease-in-out);gap:0}.zx1M1a_sessionRow .zx1M1a_title{margin:0 6px 0 4px}.zx1M1a_flatSessionRowWithoutStatus .zx1M1a_title{margin-left:0}@keyframes zx1M1a_row-in{0%{opacity:0}}.zx1M1a_slot{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.zx1M1a_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.zx1M1a_folderActive{color:var(--dsw-alias-state-business-primary)}.zx1M1a_projectRow .zx1M1a_chevron{display:none}.zx1M1a_projectRow:hover .zx1M1a_chevron{display:inline-flex}.zx1M1a_projectRow:hover .zx1M1a_folder{display:none}.zx1M1a_arrow{transition:transform .15s var(--ds-ease-in-out)}.zx1M1a_arrowOpen{transform:rotate(90deg)}.zx1M1a_projectText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.zx1M1a_title{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:20px;overflow:hidden}.zx1M1a_renameInput{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);min-width:0;color:inherit;border-radius:4px;outline:none;padding:0 2px;font-size:14px;line-height:20px}.zx1M1a_sessionRow .zx1M1a_title{flex:1}.zx1M1a_meta{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:20px;overflow:hidden}.zx1M1a_time{color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px;line-height:20px}.zx1M1a_dot{flex:none}.zx1M1a_rowActions{flex:none;align-items:center;gap:12px;display:none}.zx1M1a_projectRow:hover .zx1M1a_rowActions,.zx1M1a_sessionRow:hover .zx1M1a_rowActions,.zx1M1a_projectRow.zx1M1a_menuOpen .zx1M1a_rowActions,.zx1M1a_sessionRow.zx1M1a_menuOpen .zx1M1a_rowActions{display:inline-flex}.zx1M1a_sessionRow:hover .zx1M1a_time,.zx1M1a_sessionRow.zx1M1a_menuOpen .zx1M1a_time{display:none}.zx1M1a_projectRow.zx1M1a_menuOpen,.zx1M1a_sessionRow.zx1M1a_menuOpen{background:var(--dsw-alias-interactive-bg-hover)}.zx1M1a_sessionRow.zx1M1a_dropBefore,.zx1M1a_sessionRow.zx1M1a_dropAfter{position:relative}.zx1M1a_sessionRow.zx1M1a_dropBefore:before,.zx1M1a_sessionRow.zx1M1a_dropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:4px}.zx1M1a_sessionRow.zx1M1a_dropBefore:before{top:-7px}.zx1M1a_sessionRow.zx1M1a_dropAfter:after{bottom:-7px}.zx1M1a_hoverContent{flex-direction:column;gap:8px;display:flex}.zx1M1a_hoverTitle{color:#fff;overflow-wrap:break-word;font-size:14px;line-height:20px}.zx1M1a_hoverPath{color:#cfd3d6;word-break:break-all;font-size:12px;line-height:16px}.zx1M1a_hoverTime{color:#cfd3d6;font-size:12px;line-height:16px}.zx1M1a_hoverStatus{color:#adb2b8;align-items:center;gap:8px;font-size:12px;line-height:20px;display:flex}.zx1M1a_iconButton{cursor:pointer;width:16px;height:16px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.zx1M1a_iconButton:hover{color:var(--dsw-alias-label-primary)}.zx1M1a_chevron{color:var(--dsw-alias-label-caption)}@media (prefers-reduced-motion:reduce){.zx1M1a_sessionRow,.zx1M1a_arrow{transition:none;animation:none}}";
		...
		var Rows_module_css_default = {
			"time": "zx1M1a_time",
			"meta": "zx1M1a_meta",
			"dropAfter": "zx1M1a_dropAfter",
			"dot": "zx1M1a_dot",
			"folderActive": "zx1M1a_folderActive",
			"sessionRow": "zx1M1a_sessionRow",
			"arrow": "zx1M1a_arrow",
			"dropBefore": "zx1M1a_dropBefore",
			"title": "zx1M1a_title",
			"hoverPath": "zx1M1a_hoverPath",
			"hoverTitle": "zx1M1a_hoverTitle",
			"folder": "zx1M1a_folder",
			"hoverContent": "zx1M1a_hoverContent",
			"slot": "zx1M1a_slot",
			"searchResultSnippet": "zx1M1a_searchResultSnippet",
			"searchResultRow": "zx1M1a_searchResultRow",
			"projectText": "zx1M1a_projectText",
			"arrowOpen": "zx1M1a_arrowOpen",
			"flatSessionRowWithoutStatus": "zx1M1a_flatSessionRowWithoutStatus",
			"menuOpen": "zx1M1a_menuOpen",
			"hoverTime": "zx1M1a_hoverTime",
			"row-in": "zx1M1a_row-in",
			"searchResultTitle": "zx1M1a_searchResultTitle",
			"iconButton": "zx1M1a_iconButton",
			"rowActions": "zx1M1a_rowActions",
			"searchResultHeading": "zx1M1a_searchResultHeading",
			"renameInput": "zx1M1a_renameInput",
			"visuallyHidden": "zx1M1a_visuallyHidden",
			"selected": "zx1M1a_selected",
			"hoverStatus": "zx1M1a_hoverStatus",
			"projectRow": "zx1M1a_projectRow",
			"searchResultWorkspace": "zx1M1a_searchResultWorkspace",
			"chevron": "zx1M1a_chevron",
			"searchResultMeta": "zx1M1a_searchResultMeta"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-workspace\src\client\WorkspacePicker.module.css.mjs
		const css$1 = ".OqksKW_modalAction{min-width:72px}.OqksKW_modalError,.OqksKW_menuStatus{margin-top:8px;font-size:12px;line-height:18px}.OqksKW_modalError{color:var(--dsw-alias-state-error-primary)}.OqksKW_menuStatus{color:var(--dsw-alias-label-secondary)}";
		...
		var WorkspacePicker_module_css_default = {
			"modalError": "OqksKW_modalError",
			"modalAction": "OqksKW_modalAction",
			"menuStatus": "OqksKW_menuStatus"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-workspace\src\client\WorkspaceBrowser.module.css.mjs
		const css = ".Azx5oW_root{--dsh-session-list-edge-inset:var(--dsh-sidebar-inline-padding);--dsh-session-list-scrollbar-width:8px;--dsh-session-list-scrollbar-offset:2px;box-sizing:border-box;min-height:0;padding-right:var(--dsh-session-list-edge-inset);flex-direction:column;flex:1;display:flex}.Azx5oW_root.Azx5oW_rail{padding-right:0}.Azx5oW_iconButton{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.Azx5oW_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.Azx5oW_sectionHeader{box-sizing:border-box;height:36px;color:var(--dsw-alias-label-tertiary);border-radius:12px;flex:none;justify-content:flex-end;align-items:center;gap:4px;margin-bottom:4px;padding-left:4px;display:flex;overflow:hidden}.Azx5oW_root:not(.Azx5oW_rail) .Azx5oW_sectionHeader{margin-top:2px;margin-right:-4px}.Azx5oW_sectionLabel{white-space:nowrap;opacity:1;visibility:visible;min-width:0;max-width:45%;transition:max-width .18s var(--ds-ease-in-out), margin-right .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;line-height:20px;overflow:hidden}.Azx5oW_sectionLabelHidden{opacity:0;visibility:hidden;max-width:0;margin-right:-4px;transition-delay:0s,0s,0s,0s,.18s;transform:translate(-4px)}.Azx5oW_searchSlot{box-sizing:border-box;min-width:0;max-width:28px;transition:max-width .18s var(--ds-ease-in-out), padding-left .18s var(--ds-ease-in-out);flex:1;align-items:center;margin-left:auto;padding-left:0;display:flex}.Azx5oW_searchSlotExpanded{max-width:100%;padding-left:0}.Azx5oW_headerActions{opacity:1;visibility:visible;max-width:60px;transition:max-width .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;align-items:center;gap:4px;display:flex;overflow:hidden}.Azx5oW_headerActionsHidden{opacity:0;visibility:hidden;pointer-events:none;max-width:0;transition-delay:0s,0s,0s,.18s;transform:translate(4px)}.Azx5oW_search{box-sizing:border-box;cursor:text;width:100%;height:28px;color:var(--dsw-alias-label-secondary);transition:width .18s var(--ds-ease-in-out), padding .18s var(--ds-ease-in-out), border-color .18s var(--ds-ease-in-out), background-color .18s var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;flex:none;align-items:center;gap:0;margin:0;padding:0;display:flex;overflow:hidden}.Azx5oW_searchExpanded{border:1px solid var(--dsw-alias-border-l2);width:calc(100% + 4px);height:30px;color:var(--dsw-alias-label-caption);background:0 0;border-radius:10px;margin-inline:-2px;padding:0 4px 0 0}.Azx5oW_searchButton{cursor:pointer;width:28px;height:28px;color:inherit;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.Azx5oW_searchExpanded .Azx5oW_searchButton{width:28px;height:30px}.Azx5oW_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.Azx5oW_searchExpanded .Azx5oW_searchButton:hover{background:0 0}.Azx5oW_searchInput{opacity:0;pointer-events:none;width:0;min-width:0;color:var(--dsw-alias-label-primary);transition:opacity .12s var(--ds-ease-in-out);background:0 0;border:none;outline:none;flex:1;font-size:13px;line-height:18px}.Azx5oW_searchExpanded .Azx5oW_searchInput{opacity:1;pointer-events:auto;margin-left:-2px}.Azx5oW_searchInput::placeholder{color:var(--dsw-alias-label-tertiary)}.Azx5oW_clearButton{cursor:pointer;width:24px;height:24px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.Azx5oW_clearButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.Azx5oW_rail .Azx5oW_sectionHeader{justify-content:flex-start;gap:0;margin-bottom:12px;padding-left:0}.Azx5oW_rail .Azx5oW_headerActions{max-width:none}.Azx5oW_rail .Azx5oW_iconButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.Azx5oW_rail .Azx5oW_search{background:0 0;border-color:#0000;gap:0;width:36px;height:36px;margin:0 0 12px;padding:0}.Azx5oW_rail .Azx5oW_searchButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.Azx5oW_rail .Azx5oW_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.Azx5oW_listArea{min-height:0;margin-left:-4px;margin-right:calc(-1 * var(--dsh-session-list-edge-inset));flex-direction:column;flex:1;padding-left:4px;display:flex;overflow:visible}.Azx5oW_rail .Azx5oW_listArea{margin-left:0;margin-right:0;padding-left:0}.Azx5oW_treeBody{flex-direction:column;flex:1;min-height:0;display:flex;position:relative}.Azx5oW_fade{left:0;right:var(--dsh-session-list-edge-inset);background:linear-gradient(to bottom, transparent, var(--dsw-specific-sidebar-fill));pointer-events:none;height:24px;position:absolute;bottom:0}.Azx5oW_wide{animation:Azx5oW_wide-in .2s var(--ds-ease-in-out)}@keyframes Azx5oW_wide-in{0%{opacity:0}}.Azx5oW_list{min-height:0;margin-left:-4px;margin-right:var(--dsh-session-list-scrollbar-offset);padding-left:4px;padding-right:calc(var(--dsh-session-list-edge-inset) - var(--dsh-session-list-scrollbar-width) - var(--dsh-session-list-scrollbar-offset));scrollbar-gutter:stable;flex:1;padding-bottom:16px;overflow-y:auto}.Azx5oW_flatList>*+*,.Azx5oW_searchTree>[role=treeitem]+[role=treeitem],.Azx5oW_groupSection>*+*{margin-top:2px}.Azx5oW_searchStatus,.Azx5oW_searchWarning{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.Azx5oW_searchWarning{color:var(--dsw-alias-label-secondary)}.Azx5oW_groupSection{position:relative}.Azx5oW_groupSection+.Azx5oW_groupSection{margin-top:4px}.Azx5oW_listTopDropIndicator,.Azx5oW_workspaceDropBefore:before,.Azx5oW_workspaceDropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:0}.Azx5oW_listTopDropIndicator{top:-8px;left:0;right:var(--dsh-session-list-edge-inset)}.Azx5oW_listTopDropActive>.Azx5oW_workspaceDropBefore:first-child:before{display:none}.Azx5oW_workspaceDropBefore:before{top:-8px}.Azx5oW_workspaceDropAfter:after{bottom:-8px}.Azx5oW_sessionOverflowButton{cursor:pointer;text-align:left;width:100%;height:28px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:8px;padding:0 12px 0 28px;font-size:12px}.Azx5oW_groupSection>.Azx5oW_sessionOverflowButton{margin-top:0}.Azx5oW_sessionOverflowButton:hover{color:var(--dsw-alias-label-secondary);background:0 0}.Azx5oW_empty{color:var(--dsw-alias-label-tertiary);padding:16px 12px;font-size:13px}.Azx5oW_renameInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;font-weight:400;line-height:22px}.Azx5oW_renameInput:disabled{color:var(--dsw-alias-label-dimmed)}.Azx5oW_renameError{color:var(--dsw-alias-state-error-primary);margin-top:8px;font-size:12px;line-height:18px}.Azx5oW_deleteAction:not(:disabled){color:var(--dsw-alias-state-error-primary)}.Azx5oW_deleteStatus{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){.Azx5oW_wide{animation:none}.Azx5oW_search,.Azx5oW_sectionLabel,.Azx5oW_searchSlot,.Azx5oW_searchInput,.Azx5oW_headerActions{transition:none}}";
		...
		var WorkspaceBrowser_module_css_default = {
			"searchWarning": "Azx5oW_searchWarning",
			"renameError": "Azx5oW_renameError",
			"sectionLabelHidden": "Azx5oW_sectionLabelHidden",
			"iconButton": "Azx5oW_iconButton",
			"sectionHeader": "Azx5oW_sectionHeader",
			"clearButton": "Azx5oW_clearButton",
			"searchExpanded": "Azx5oW_searchExpanded",
			"fade": "Azx5oW_fade",
			"search": "Azx5oW_search",
			"flatList": "Azx5oW_flatList",
			"sessionOverflowButton": "Azx5oW_sessionOverflowButton",
			"list": "Azx5oW_list",
			"listTopDropIndicator": "Azx5oW_listTopDropIndicator",
			"workspaceDropBefore": "Azx5oW_workspaceDropBefore",
			"headerActionsHidden": "Azx5oW_headerActionsHidden",
			"rail": "Azx5oW_rail",
			"searchSlot": "Azx5oW_searchSlot",
			"searchSlotExpanded": "Azx5oW_searchSlotExpanded",
			"searchInput": "Azx5oW_searchInput",
			"listTopDropActive": "Azx5oW_listTopDropActive",
			"deleteAction": "Azx5oW_deleteAction",
			"renameInput": "Azx5oW_renameInput",
			"searchTree": "Azx5oW_searchTree",
			"searchStatus": "Azx5oW_searchStatus",
			"root": "Azx5oW_root",
			"wide-in": "Azx5oW_wide-in",
			"searchButton": "Azx5oW_searchButton",
			"empty": "Azx5oW_empty",
			"headerActions": "Azx5oW_headerActions",
			"listArea": "Azx5oW_listArea",
			"sectionLabel": "Azx5oW_sectionLabel",
			"groupSection": "Azx5oW_groupSection",
			"deleteStatus": "Azx5oW_deleteStatus",
			"treeBody": "Azx5oW_treeBody",
			"workspaceDropAfter": "Azx5oW_workspaceDropAfter",
			"wide": "Azx5oW_wide"
		};
		//#endregion
