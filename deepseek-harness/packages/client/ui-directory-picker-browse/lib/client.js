window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-directory-picker-browse\src\client\DirectoryBrowser.module.css.mjs
		const css = ".uzPxPW_dialog.uzPxPW_dialog{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);gap:0;width:min(680px,100%);height:min(500px,100dvh - 32px);padding:0}.uzPxPW_editorScope{display:contents}.uzPxPW_header{border-bottom:1px solid var(--dsw-alias-border-l3);flex-direction:column;flex:none;gap:8px;padding:16px 14px 8px 24px;display:flex}.uzPxPW_title{min-height:28px;color:var(--dsw-alias-label-primary);align-items:flex-end;margin:0;font-size:16px;font-weight:510;line-height:24px;display:flex}.uzPxPW_crumbBar{box-sizing:border-box;border:1px solid #0000;border-radius:8px;align-items:center;gap:4px;min-height:24px;margin-left:-9px;padding:0 8px;display:flex}.uzPxPW_crumbBar:has(.uzPxPW_crumbEditZone:enabled:hover),.uzPxPW_crumbBar:has(.uzPxPW_crumbEditZone:focus-visible),.uzPxPW_crumbBar:has(.uzPxPW_pathInput){border-color:var(--dsw-alias-border-l2)}.uzPxPW_millerRow{scrollbar-width:none;flex:1 1 0;align-items:stretch;gap:12px;min-height:0;display:flex;overflow-x:auto}.uzPxPW_crumbTrail{scrollbar-width:none;flex:0 auto;align-items:center;gap:4px;min-width:0;display:flex;overflow-x:auto}.uzPxPW_crumbSeat{flex:none;align-items:center;gap:4px;min-width:0;display:inline-flex}.uzPxPW_crumb{text-overflow:ellipsis;white-space:nowrap;max-width:160px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;padding:0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.uzPxPW_crumb:hover{color:var(--dsw-alias-label-primary)}.uzPxPW_crumbChevron{color:var(--dsw-alias-label-tertiary);flex:none}.uzPxPW_crumbEditZone{cursor:text;background:0 0;border:none;outline:none;flex:1 0 34px;justify-content:flex-end;align-items:center;min-width:34px;height:22px;padding:0;display:flex}.uzPxPW_crumbEditGlyph{color:var(--dsw-alias-label-tertiary);flex:none}.uzPxPW_crumbEditZone:enabled:hover .uzPxPW_crumbEditGlyph,.uzPxPW_crumbEditZone:focus-visible .uzPxPW_crumbEditGlyph{color:var(--dsw-alias-label-primary)}.uzPxPW_crumbEditZone:disabled{cursor:default}.uzPxPW_crumbEditZone:disabled .uzPxPW_crumbEditGlyph{color:var(--dsw-alias-label-caption)}.uzPxPW_pathInput{box-sizing:border-box;min-width:0;height:22px;color:var(--dsw-alias-label-primary);background:0 0;border:none;outline:none;flex:1 1 0;padding:0;font-size:13px;line-height:20px}.uzPxPW_content{flex-direction:column;flex:1 1 0;min-height:0;padding:16px 16px 16px 24px;display:flex;position:relative}.uzPxPW_column{flex-direction:column;flex:1 1 0;gap:2px;min-width:256px;padding-right:8px;display:flex;overflow-y:auto}.uzPxPW_divider{background:var(--dsw-alias-border-l3);flex:none;width:1px}.uzPxPW_rowSeat{flex:none;display:flex}.uzPxPW_row{text-align:left;cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;align-items:center;gap:4px;width:100%;height:28px;padding:4px;display:flex}.uzPxPW_row:hover{background:var(--dsw-alias-interactive-bg-hover)}.uzPxPW_rowSelected,.uzPxPW_rowSelected:hover{background:var(--dsw-alias-interactive-bg-active,var(--dsw-alias-interactive-bg-hover))}.uzPxPW_rowIcon{color:var(--dsw-alias-label-secondary);flex:none}.uzPxPW_rowIconSelected{color:var(--dsw-alias-button-info-fill);flex:none}.uzPxPW_rowName{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-primary);flex:1 1 0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.uzPxPW_rowChevron{color:var(--dsw-alias-label-tertiary);flex:none}.uzPxPW_status,.uzPxPW_error{padding:4px 120px 4px 4px;font-size:12px;line-height:18px}.uzPxPW_status{color:var(--dsw-alias-label-secondary)}.uzPxPW_error{color:var(--dsw-alias-state-error-primary)}.uzPxPW_loadingFloat{background:var(--dsw-alias-bg-layer-2);padding:2px 8px;position:absolute;bottom:8px;right:16px}.uzPxPW_footerBar{border-top:1px solid var(--dsw-alias-border-l3);flex-wrap:wrap;flex:none;align-items:center;gap:8px;padding:16px 24px;display:flex}.uzPxPW_showHiddenToggle{color:var(--dsw-alias-label-secondary);cursor:pointer;white-space:nowrap;background:0 0;border:none;align-items:center;gap:4px;padding:0;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}.uzPxPW_showHiddenToggle:hover{color:var(--dsw-alias-label-primary)}.uzPxPW_showHiddenToggle:disabled{color:var(--dsw-alias-label-caption);cursor:default}.uzPxPW_showHiddenToggleActive{color:var(--dsw-alias-label-primary)}.uzPxPW_footerGap{flex:1 1 0}.uzPxPW_footerAction{min-width:72px}.uzPxPW_createDialog.uzPxPW_createDialog{gap:0;width:min(380px,100%);padding:0}.uzPxPW_createBody{flex-direction:column;gap:12px;padding:22px 24px 20px;display:flex}.uzPxPW_createTitle{color:var(--dsw-alias-label-primary);margin:0;font-size:16px;font-weight:510;line-height:24px}.uzPxPW_createIn{color:var(--dsw-alias-label-primary);margin:0;font-size:14px;line-height:22px}.uzPxPW_createInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;line-height:22px}.uzPxPW_createInput::placeholder{color:var(--dsw-alias-label-caption)}.uzPxPW_createActions{justify-content:flex-end;align-items:center;gap:8px;margin-top:8px;display:flex}";
		...
		var DirectoryBrowser_module_css_default = {
			"pathInput": "uzPxPW_pathInput",
			"crumbChevron": "uzPxPW_crumbChevron",
			"footerBar": "uzPxPW_footerBar",
			"rowName": "uzPxPW_rowName",
			"footerGap": "uzPxPW_footerGap",
			"showHiddenToggleActive": "uzPxPW_showHiddenToggleActive",
			"rowChevron": "uzPxPW_rowChevron",
			"footerAction": "uzPxPW_footerAction",
			"header": "uzPxPW_header",
			"createTitle": "uzPxPW_createTitle",
			"createActions": "uzPxPW_createActions",
			"error": "uzPxPW_error",
			"content": "uzPxPW_content",
			"createIn": "uzPxPW_createIn",
			"dialog": "uzPxPW_dialog",
			"createDialog": "uzPxPW_createDialog",
			"rowSelected": "uzPxPW_rowSelected",
			"showHiddenToggle": "uzPxPW_showHiddenToggle",
			"column": "uzPxPW_column",
			"rowIcon": "uzPxPW_rowIcon",
			"editorScope": "uzPxPW_editorScope",
			"loadingFloat": "uzPxPW_loadingFloat",
			"crumb": "uzPxPW_crumb",
			"status": "uzPxPW_status",
			"divider": "uzPxPW_divider",
			"createInput": "uzPxPW_createInput",
			"createBody": "uzPxPW_createBody",
			"title": "uzPxPW_title",
			"crumbTrail": "uzPxPW_crumbTrail",
			"rowSeat": "uzPxPW_rowSeat",
			"millerRow": "uzPxPW_millerRow",
			"rowIconSelected": "uzPxPW_rowIconSelected",
			"row": "uzPxPW_row",
			"crumbBar": "uzPxPW_crumbBar",
			"crumbSeat": "uzPxPW_crumbSeat",
			"crumbEditGlyph": "uzPxPW_crumbEditGlyph",
			"crumbEditZone": "uzPxPW_crumbEditZone"
		};
		//#endregion
