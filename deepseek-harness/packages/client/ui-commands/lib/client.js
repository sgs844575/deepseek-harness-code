window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-commands\src\client\PopupSelectView.module.css.mjs
		const css = ".IoffVG_card{z-index:100;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);min-width:min(220px,100%);max-width:100%;max-height:320px;box-shadow:var(--dsw-shadow-lv3);border-radius:12px;outline:none;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 4px);left:0;overflow:hidden}.IoffVG_viewport{flex-direction:column;min-height:0;display:flex;overflow-y:auto}.IoffVG_row{cursor:pointer;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:13px;display:flex}.IoffVG_rowActive{background:var(--dsw-alias-interactive-bg-hover)}.IoffVG_label{white-space:nowrap;text-overflow:ellipsis;flex:auto;min-width:0;overflow:hidden}.IoffVG_detail{color:var(--dsw-alias-label-tertiary);white-space:nowrap;text-overflow:ellipsis;font-size:12px;overflow:hidden}.IoffVG_check{color:var(--dsw-alias-label-primary);flex:none;display:inline-flex}.IoffVG_status{color:var(--dsw-alias-label-tertiary);padding:8px 10px;font-size:13px}.IoffVG_search{border:1px solid var(--dsw-alias-border-inverted);color:var(--dsw-alias-label-primary);background:0 0;border-radius:8px;outline:none;margin:2px 2px 4px;padding:6px 8px;font-size:13px}.IoffVG_error{color:var(--dsw-alias-state-error-primary);align-items:center;gap:8px;padding:6px 8px;font-size:12px;display:flex}.IoffVG_errorText{text-overflow:ellipsis;flex:1;overflow:hidden}.IoffVG_retry{border:1px solid var(--dsw-alias-border-inverted);color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:6px;padding:2px 8px;font-size:12px}";
		...
		var PopupSelectView_module_css_default = {
			"retry": "IoffVG_retry",
			"label": "IoffVG_label",
			"viewport": "IoffVG_viewport",
			"row": "IoffVG_row",
			"errorText": "IoffVG_errorText",
			"card": "IoffVG_card",
			"detail": "IoffVG_detail",
			"status": "IoffVG_status",
			"check": "IoffVG_check",
			"search": "IoffVG_search",
			"rowActive": "IoffVG_rowActive",
			"error": "IoffVG_error"
		};
		//#endregion
