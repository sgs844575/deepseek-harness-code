window.__ModuleLoader__.load({
 ...
 /* istanbul ignore else */
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-trajectory\src\client\TrajectoryTable.module.css.mjs
		const css$3 = "._2kIxCW_split{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-alias-bg-layer-1);flex:1;width:100%;min-height:0;display:flex;position:relative;overflow:hidden;container-type:inline-size}._2kIxCW_tablePane{min-width:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);flex:1;position:relative;overflow:hidden auto;container:_2kIxCW_trajectory-table/inline-size}._2kIxCW_historyLoading{z-index:5;pointer-events:none;height:0;position:sticky;top:0;overflow:visible}._2kIxCW_historyLoadingBar{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;height:30px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);justify-content:center;align-items:center;gap:6px;display:flex}._2kIxCW_historyLoadingSpinner{box-sizing:border-box;border:1.5px solid var(--dsw-alias-border-l2);border-top-color:var(--dsw-alias-state-business-primary);border-radius:50%;width:10px;height:10px;animation:.7s linear infinite _2kIxCW_history-loading-spin}._2kIxCW_table tbody ._2kIxCW_historyLoadRow td{height:30px;padding:0}._2kIxCW_table tbody ._2kIxCW_historyLoadRow+tr[data-turn-start=true] td:before{content:none}._2kIxCW_historyLoadButton{background:var(--dsw-alias-bg-layer-1);width:100%;height:29px;color:var(--dsw-alias-label-secondary);cursor:pointer;font:var(--dsw-font-xxs-12);border:0;justify-content:center;align-items:center;gap:6px;display:flex}._2kIxCW_historyLoadButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._2kIxCW_historyLoadButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}._2kIxCW_historyLoadButton:disabled{cursor:default}._2kIxCW_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}._2kIxCW_table:not([data-scroll-ready=true]){visibility:hidden}@keyframes _2kIxCW_history-loading-spin{to{transform:rotate(360deg)}}@media (prefers-reduced-motion:reduce){._2kIxCW_historyLoadingSpinner{animation:none}}._2kIxCW_table{--trajectory-turn-accent:color-mix(in srgb, var(--dsw-static-blue-500) 22%, var(--dsw-alias-bg-layer-1));border-spacing:0;table-layout:fixed;width:100%;min-width:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xxs-12)}._2kIxCW_eventColumn{width:122px}._2kIxCW_contentColumn{width:auto}._2kIxCW_table th{z-index:3;box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);height:30px;color:var(--dsw-alias-label-tertiary);background:var(--dsw-specific-sidebar-fill);font:var(--dsw-font-xxs-12);text-align:left;text-overflow:ellipsis;user-select:none;white-space:nowrap;padding:0 8px;font-weight:500;position:sticky;top:0;overflow:hidden}._2kIxCW_eventHeader{text-align:right!important;padding-right:4px!important}._2kIxCW_table td{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l1);text-overflow:ellipsis;white-space:nowrap;height:30px;padding:0 8px;overflow:hidden}._2kIxCW_table tbody ._2kIxCW_virtualSpacer{pointer-events:none}._2kIxCW_table tbody ._2kIxCW_virtualSpacer td{height:var(--trajectory-virtual-spacer-height);border:0;padding:0}._2kIxCW_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]){cursor:default;transition:background-color .12s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out);outline:none}._2kIxCW_table tbody tr[data-timeline-focus=outside]{opacity:.24}._2kIxCW_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]):not([data-selected=true]):hover{background:var(--dsw-alias-interactive-bg-hover)}._2kIxCW_table tbody tr[data-request-only=true]:hover{background:0 0}._2kIxCW_table tbody tr[data-request-only=true] td{border-bottom:0;height:0;padding-top:0;padding-bottom:0}._2kIxCW_table tbody tr[data-terminal-request-boundary=true] td{height:9px}._2kIxCW_table tbody tr[data-request-only=true] ._2kIxCW_turnRail{top:-15px;bottom:0}._2kIxCW_table tbody tr:not([data-collapsed-summary]):focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}._2kIxCW_table tbody tr[data-selected=true]{background:var(--dsw-alias-interactive-bg-active)}._2kIxCW_requestBoundaryControl{--request-boundary-base-left:12px;z-index:6;top:-8px;left:calc(var(--request-boundary-base-left) + var(--request-boundary-offset,0px));cursor:pointer;background:0 0;border:0;width:16px;height:16px;padding:0;position:absolute}._2kIxCW_requestBoundaryControl:before{background:var(--dsw-alias-label-caption);width:5px;height:5px;box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-1), 0 0 0 3px transparent;content:\"\";transition:background .12s var(--ds-ease-in-out), box-shadow .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:5.5px;left:5.5px}._2kIxCW_requestBoundaryControl:after{border:1px solid var(--dsw-alias-border-l1);width:max-content;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);content:attr(data-label);font:9px/12px var(--ds-font-family-code);opacity:0;pointer-events:none;transition:opacity .12s var(--ds-ease-in-out), transform .12s var(--ds-ease-in-out);user-select:none;white-space:nowrap;border-radius:2px;padding:0 4px;position:absolute;top:2px;left:17px;transform:translate(-2px);box-shadow:0 2px 6px #0000001f}._2kIxCW_requestBoundaryControl:hover:before,._2kIxCW_requestBoundaryControl:focus-visible:before{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color)}._2kIxCW_requestBoundaryControlActive:before,._2kIxCW_requestBoundaryControlActive:hover:before,._2kIxCW_requestBoundaryControlActive:focus-visible:before{background:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 18%, var(--dsw-alias-bg-layer-1));box-shadow:0 0 0 1.5px var(--dsw-alias-brand-primary-new-colorprimary-new-color)}._2kIxCW_requestBoundaryControl[data-request-status=error]:before,._2kIxCW_requestBoundaryControl[data-request-status=error]:hover:before,._2kIxCW_requestBoundaryControl[data-request-status=error]:focus-visible:before{background:var(--dsw-alias-state-error-primary)}._2kIxCW_requestBoundaryControl:hover:after,._2kIxCW_requestBoundaryControl:focus-visible:after{opacity:1;transform:translate(0)}._2kIxCW_requestBoundaryControl:focus-visible{outline:none}._2kIxCW_table tbody tr:has(._2kIxCW_requestBoundaryControl:hover):not([data-selected=true]){background:0 0}._2kIxCW_event{position:relative}._2kIxCW_turnRail,._2kIxCW_selectionRail{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color);pointer-events:none;position:absolute;left:0}._2kIxCW_turnRail{z-index:4;background:var(--trajectory-turn-accent);width:2px;top:-1px;bottom:-1px}._2kIxCW_table tbody tr[data-turn-end=true] ._2kIxCW_turnRail{bottom:0}._2kIxCW_selectionRail{z-index:5;width:3px;top:0;bottom:0}._2kIxCW_table tbody tr[data-error=true] ._2kIxCW_turnRail{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 22%, var(--dsw-alias-bg-layer-1))}._2kIxCW_table tbody tr[data-error=true] ._2kIxCW_selectionRail{background:var(--dsw-alias-state-error-primary)}._2kIxCW_table tbody tr[data-turn-start=true] td{position:relative;overflow:visible}._2kIxCW_table tbody tr[data-turn-start=true]:not(:first-child) td:before{z-index:1;background:var(--dsw-alias-border-l1);content:\"\";pointer-events:none;height:2px;position:absolute;top:0;left:0;right:0;transform:translateY(-50%)}._2kIxCW_event{padding-left:36px!important;padding-right:4px!important;overflow:visible!important}._2kIxCW_turnLabel{z-index:3;box-sizing:border-box;width:max-content;color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-module-platform);font:8px/10px var(--ds-font-family-code);font-variant-numeric:tabular-nums;user-select:none;white-space:nowrap;border-radius:0 0 2px;flex:none;align-items:center;padding:1px 5px;display:inline-grid;position:absolute;top:0;left:0}._2kIxCW_turnLabelFull,._2kIxCW_turnLabelCompact{opacity:1;white-space:nowrap;grid-area:1/1;max-width:64px;overflow:hidden}._2kIxCW_turnLabelCompact{opacity:0;max-width:0}._2kIxCW_turnLabelActive{color:color-mix(in srgb, var(--dsw-static-blue-500) 55%, var(--dsw-alias-label-tertiary));background:var(--trajectory-turn-accent)}._2kIxCW_eventInner{justify-content:flex-start;align-items:center;min-width:0;height:100%;display:flex}._2kIxCW_kindSlot{flex:none;justify-content:flex-end;align-items:flex-end;width:76px;display:flex}._2kIxCW_kindSlot [role=tooltip]{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary)}._2kIxCW_content{color:var(--dsw-alias-label-primary);padding-left:4px!important}._2kIxCW_kindTag{box-sizing:border-box;letter-spacing:.035em;user-select:none;border:1px solid #0000;border-radius:4px;flex:none;align-items:center;height:19px;padding:0 5px;font-size:10px;font-weight:650;line-height:16px;display:inline-flex}._2kIxCW_kindTagIcon{opacity:0;flex:none;justify-content:center;align-items:center;width:0;height:13px;display:inline-flex;overflow:hidden;transform:scale(.8)}._2kIxCW_kindTagLabel{opacity:1;white-space:nowrap;max-width:72px;display:inline-block;overflow:hidden}._2kIxCW_table ._2kIxCW_kindSlot ._2kIxCW_message{justify-content:center;width:100%}@container _2kIxCW_trajectory-table (width<=620px){._2kIxCW_eventColumn{width:50px}._2kIxCW_event{padding-left:28px!important;padding-right:3px!important}._2kIxCW_requestBoundaryControl{--request-boundary-base-left:6px}._2kIxCW_kindSlot{width:19px}._2kIxCW_kindTag,._2kIxCW_table ._2kIxCW_kindSlot ._2kIxCW_message{justify-content:center;width:19px;padding-left:0;padding-right:0}._2kIxCW_kindTagIcon{opacity:1;width:13px;transform:scale(1)}._2kIxCW_kindTagLabel,._2kIxCW_turnLabelFull{opacity:0;max-width:0}._2kIxCW_turnLabelCompact{opacity:1;max-width:64px}}@media (prefers-reduced-motion:no-preference){._2kIxCW_eventColumn,._2kIxCW_event,._2kIxCW_requestBoundaryControl,._2kIxCW_kindSlot,._2kIxCW_kindTag,._2kIxCW_kindTagIcon,._2kIxCW_kindTagLabel,._2kIxCW_turnLabelFull,._2kIxCW_turnLabelCompact{transition-duration:.18s;transition-timing-function:var(--ds-ease-in-out)}._2kIxCW_eventColumn,._2kIxCW_kindSlot{transition-property:width}._2kIxCW_event{transition-property:padding-right,padding-left}._2kIxCW_requestBoundaryControl{transition-property:left}._2kIxCW_kindTag{transition-property:padding-right,padding-left}._2kIxCW_kindTagIcon{transition-property:width,opacity,transform}._2kIxCW_kindTagLabel,._2kIxCW_turnLabelFull,._2kIxCW_turnLabelCompact{transition-property:max-width,opacity}}._2kIxCW_user{color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-tertiary)}._2kIxCW_systemNeutral{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}._2kIxCW_contextGreen{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary));background:var(--dsw-alias-state-success-tertiary)}._2kIxCW_compacted{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}._2kIxCW_compactedSummary{font:var(--dsw-font-xs-13);margin-top:12px;padding:0 0 14px}._2kIxCW_promptDiffSections{flex-direction:column;gap:14px;max-height:100%;padding:10px 14px 14px;display:flex;overflow:auto}._2kIxCW_promptDiffSection{min-width:0}._2kIxCW_promptDiffTitle{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0 0 6px}._2kIxCW_promptDiff{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:11px/17px var(--ds-font-family-code);white-space:pre;margin:0;overflow:auto}._2kIxCW_promptDiff span{min-width:max-content;padding:0 6px;display:block}._2kIxCW_promptDiffLinemeta{color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-module-platform);user-select:none}._2kIxCW_promptDiffLinecontext{color:var(--dsw-alias-label-secondary)}._2kIxCW_promptDiffLineadded{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 72%, var(--dsw-alias-label-primary));background:var(--dsw-alias-state-success-tertiary)}._2kIxCW_promptDiffLineremoved{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, var(--dsw-alias-bg-layer-1))}._2kIxCW_assistantVioletBright{color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));background:color-mix(in srgb, color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 55%, var(--dsw-alias-state-error-secondary)) 15%, var(--dsw-alias-bg-layer-1))}._2kIxCW_toolAmber{color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary)}._2kIxCW_subtoolAmber{color:color-mix(in srgb, var(--dsw-alias-state-warn-label) 62%, var(--dsw-alias-label-tertiary));background:color-mix(in srgb, var(--dsw-alias-state-warn-tertiary) 58%, var(--dsw-alias-bg-layer-1))}._2kIxCW_contentText{text-overflow:ellipsis;white-space:nowrap;min-width:0;display:block;overflow:hidden}._2kIxCW_toolCallOnly{color:var(--dsw-alias-label-tertiary)}._2kIxCW_table tbody tr[data-collapsed-summary=turn] td,._2kIxCW_table tbody tr[data-collapsed-summary=assistant] td{height:20px}._2kIxCW_table tbody tr[data-collapsed-summary]{cursor:pointer;transition:background-color .12s var(--ds-ease-in-out);outline:none}._2kIxCW_table tbody tr[data-collapsed-summary]:hover{background:var(--dsw-alias-interactive-bg-hover)}._2kIxCW_table tbody tr[data-collapsed-summary]:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}._2kIxCW_collapsedTurnContent{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;font-size:12px;line-height:16px;display:flex}._2kIxCW_collapsedTurnEllipsis{color:var(--dsw-alias-label-tertiary);user-select:none;flex:none;margin-right:6px;font-weight:600}._2kIxCW_collapsedTurnText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}._2kIxCW_resultPreview{grid-template-columns:clamp(180px, var(--trajectory-tool-request-width,calc(36cqw - 56px)), 480px) minmax(0, 1fr);align-items:center;gap:8px;min-width:0;display:grid}._2kIxCW_resultRequest,._2kIxCW_inlineResultText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}._2kIxCW_toolCallNameTypeface{color:var(--dsw-alias-label-primary);font:400 12px/18px Menlo,Consolas,Liberation Mono,PingFang SC,Microsoft YaHei}._2kIxCW_toolCallPayload{color:var(--dsw-alias-label-secondary);font:400 12px/18px var(--ds-font-family-code);margin-left:7px}._2kIxCW_table tbody tr[data-kind=tool] ._2kIxCW_contentText,._2kIxCW_table tbody tr[data-kind=subtool] ._2kIxCW_contentText,._2kIxCW_table tbody tr[data-kind=tool] ._2kIxCW_resultPreview,._2kIxCW_table tbody tr[data-kind=subtool] ._2kIxCW_resultPreview{font-family:var(--ds-font-family-code);font-size:12px}._2kIxCW_table tbody tr[data-kind=subtool] ._2kIxCW_content{padding-left:26px}._2kIxCW_inlineResult{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;display:flex}._2kIxCW_noOutputText{color:var(--dsw-alias-label-caption)}._2kIxCW_arrow{color:var(--dsw-alias-label-caption);flex:none;margin-right:8px}._2kIxCW_error,._2kIxCW_overview dd._2kIxCW_error,._2kIxCW_details ._2kIxCW_errorPayload{color:var(--dsw-alias-state-error-primary)}._2kIxCW_details ._2kIxCW_errorPayload ._2kIxCW_resultBlockText{color:inherit}._2kIxCW_details ._2kIxCW_jsonPayload._2kIxCW_errorPayload,._2kIxCW_details ._2kIxCW_jsonPreview._2kIxCW_errorPayload{--json-tree-property:var(--dsw-alias-state-error-primary);--json-tree-string:var(--dsw-alias-state-error-primary);--json-tree-number:var(--dsw-alias-state-error-primary);--json-tree-keyword:var(--dsw-alias-state-error-primary);--json-tree-punctuation:var(--dsw-alias-state-error-primary);--json-tree-icon:var(--dsw-alias-state-error-primary)}._2kIxCW_details{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);flex-direction:column;flex:none;width:clamp(320px,38%,440px);min-width:0;max-width:calc(100% - 280px);min-height:0;display:flex;position:relative}._2kIxCW_detailsResizeHandle{z-index:6;cursor:col-resize;touch-action:none;user-select:none;background:0 0;border:0;width:8px;padding:0;position:absolute;top:0;bottom:0;left:-4px}._2kIxCW_detailsResizeHandle:focus-visible{outline:none}._2kIxCW_detailsHeader{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;justify-content:space-between;align-items:center;height:42px;padding:0 8px 0 12px;display:flex}._2kIxCW_detailsTitle{min-width:0;color:var(--dsw-alias-label-primary);align-items:center;gap:8px;display:flex}._2kIxCW_requestDetailsDot{background:var(--dsw-alias-label-secondary);border-radius:50%;flex:none;width:5px;height:5px}._2kIxCW_requestDetailsName{font:500 12px/16px var(--ds-font-family-code);flex:none}._2kIxCW_detailsLocation{min-width:0;color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._2kIxCW_close{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;font-size:18px;line-height:18px;display:inline-flex}._2kIxCW_close:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}._2kIxCW_detailTabs{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);overscroll-behavior-x:contain;scrollbar-width:none;white-space:nowrap;flex:none;gap:1px;width:100%;min-width:0;max-width:100%;height:34px;padding:0 8px;display:flex;overflow:auto hidden}._2kIxCW_detailTabs::-webkit-scrollbar{display:none}._2kIxCW_detailTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;flex:none;padding:0 9px;position:relative}._2kIxCW_detailTab:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}._2kIxCW_detailTabActive{color:var(--dsw-alias-state-business-primary)}._2kIxCW_detailTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:9px;right:9px}._2kIxCW_close:focus-visible,._2kIxCW_detailTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}._2kIxCW_detailBody{min-height:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);scrollbar-gutter:stable;flex:1;overflow:hidden auto}._2kIxCW_detailBodySummary{box-sizing:border-box;padding-bottom:calc(12px + var(--dsh-trajectory-bottom-clearance,0px));flex-direction:column;display:flex;overflow:hidden}._2kIxCW_detailBodySummary>._2kIxCW_overview{overscroll-behavior:contain;flex:0 auto;min-height:0;overflow:auto}._2kIxCW_detailBodySummary>._2kIxCW_compactedSummary{flex:1;min-height:0;overflow:auto}._2kIxCW_summaryScrollRegion{--dsh-scrollbar-thumb:transparent;--dsh-scrollbar-thumb-hover:transparent}._2kIxCW_summaryScrollRegion:hover,._2kIxCW_summaryScrollRegion:focus-within{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2)}._2kIxCW_compactedSummary ._2kIxCW_markdownPayload{padding-right:18px}._2kIxCW_overview{font:var(--dsw-font-xs-13);margin:0;padding:8px 0}._2kIxCW_overviewParentLinks{gap:14px;display:flex}._2kIxCW_overviewHierarchyNavLink{all:unset;color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;opacity:1;align-items:center;gap:1px;display:inline-flex}._2kIxCW_overviewHierarchyNavLink:hover{color:var(--dsw-alias-label-primary)}._2kIxCW_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-caption);flex:none}._2kIxCW_overviewHierarchyNavLink:hover ._2kIxCW_overviewHierarchyJumpIconTight,._2kIxCW_overviewHierarchyNavLink:focus-visible ._2kIxCW_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-primary)}._2kIxCW_overviewHierarchyNavLink:focus-visible{color:var(--dsw-alias-label-primary);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}._2kIxCW_overview>div{grid-template-columns:94px minmax(0,1fr);align-items:center;min-height:22px;padding:0 14px;display:grid}._2kIxCW_overview>._2kIxCW_requestTokenDetail dt{padding-left:12px}._2kIxCW_usagePanel{padding:4px 0 10px}._2kIxCW_usageGroup+._2kIxCW_usageGroup{margin-top:8px}._2kIxCW_usageHeading{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0;padding:4px 14px 1px}._2kIxCW_usageGroup ._2kIxCW_overview{padding:0}._2kIxCW_overview dt{color:var(--dsw-alias-label-tertiary)}._2kIxCW_overview dd{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;margin:0;overflow:hidden}._2kIxCW_timestampToggle{all:unset;color:inherit;cursor:pointer;font:inherit;user-select:text}._2kIxCW_timestampToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}._2kIxCW_overviewSections{border-top:0;flex-direction:column;flex:1;min-height:min-content;display:flex;overflow:hidden}._2kIxCW_overviewSection{flex-direction:column;flex:1 1 0;min-height:28px;max-height:max-content;display:flex;overflow:hidden}._2kIxCW_overviewSection+._2kIxCW_overviewSection{padding-top:8px}._2kIxCW_overviewHeading{box-sizing:border-box;width:100%;height:28px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xs-strong-13);user-select:none;flex:none;align-items:flex-end;margin:0;padding:0 0 3px 14px;display:flex}._2kIxCW_overviewTitle{width:max-content;height:auto;color:inherit;cursor:pointer;font:inherit;user-select:none;background:0 0;border:0;flex:none;align-items:center;gap:3px;padding:0;line-height:1;display:inline-flex}._2kIxCW_overviewTitleIcon{color:var(--dsw-alias-label-caption);flex:none}._2kIxCW_overviewTitle:hover ._2kIxCW_overviewTitleIcon{color:var(--dsw-alias-label-primary)}._2kIxCW_overviewTitle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}._2kIxCW_overviewTitle:focus-visible ._2kIxCW_overviewTitleIcon{color:var(--dsw-alias-state-business-primary)}._2kIxCW_overviewPreview{overscroll-behavior:contain;background:var(--dsw-alias-bg-layer-1);flex:1;min-height:0;overflow:auto}._2kIxCW_overviewPreview>:last-child{margin-bottom:0;padding-bottom:0}._2kIxCW_overviewPreview ._2kIxCW_jsonPreview>:first-child,._2kIxCW_overviewPreview ._2kIxCW_schemaTree>:first-child{padding-bottom:0}._2kIxCW_overviewPreview ._2kIxCW_schemaTree{margin-bottom:0}._2kIxCW_overviewPreview ._2kIxCW_overview{padding:2px 0 0}._2kIxCW_overviewPreview ._2kIxCW_overview>div{min-height:22px}._2kIxCW_markdownPreview,._2kIxCW_markdownPayload{color:var(--dsw-alias-label-primary)}._2kIxCW_markdownPreview>div,._2kIxCW_markdownPayload>div{font:var(--dsw-font-xs-13);gap:8px}._2kIxCW_markdownPreview>div h1,._2kIxCW_markdownPayload>div h1{font:600 16px/22px var(--dsw-font-family)}._2kIxCW_markdownPreview>div h2,._2kIxCW_markdownPayload>div h2{font:600 15px/22px var(--dsw-font-family)}._2kIxCW_markdownPreview>div :where(h3,h4,h5,h6),._2kIxCW_markdownPayload>div :where(h3,h4,h5,h6){font:600 14px/20px var(--dsw-font-family)}._2kIxCW_markdownPreview>div :not(pre)>code,._2kIxCW_markdownPayload>div :not(pre)>code{font:12px/18px var(--ds-font-family-code)}._2kIxCW_markdownPreview>div table,._2kIxCW_markdownPayload>div table{font:var(--dsw-font-xs-13)}._2kIxCW_markdownPreview>div>:first-child{margin-top:0}._2kIxCW_markdownPreview>div>:last-child{margin-bottom:0}._2kIxCW_markdownPreview>div :where(h1,h2,h3){margin:12px 0 6px}._2kIxCW_markdownPreview>div :where(h4,h5,h6){margin:10px 0 5px}._2kIxCW_markdownPreview>div :where(p,ul,ol){margin:8px 0}._2kIxCW_markdownPreview>div li:not(:first-child){margin-top:3px}._2kIxCW_markdownPreview>div blockquote{margin-top:8px}._2kIxCW_markdownPreview>div hr{margin:14px 0}._2kIxCW_markdownPreview>div>.md-code-block{margin:10px 0}._2kIxCW_assistantContent ._2kIxCW_markdownPayload,._2kIxCW_assistantContent ._2kIxCW_payload{min-height:0}._2kIxCW_thinkingQuote{border-left:2px solid var(--dsw-alias-markdown-citation);color:var(--dsw-alias-label-secondary);background:0 0;margin:6px 14px 0 12px;padding-left:6px}._2kIxCW_thinkingQuoteOnlyPreview{margin-bottom:8px}._2kIxCW_detailBody>._2kIxCW_assistantContentRendered ._2kIxCW_thinkingQuote{margin-top:14px}._2kIxCW_thinkingToggle{width:max-content;height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:600 12px/18px var(--dsw-font-family);user-select:none;background:0 0;border:0;align-items:center;gap:2px;padding:0;display:flex}._2kIxCW_thinkingChevron{transition:transform .12s var(--ds-ease-in-out);flex:none}._2kIxCW_thinkingToggle[aria-expanded=true] ._2kIxCW_thinkingChevron{transform:rotate(90deg)}._2kIxCW_thinkingToggle:hover{color:var(--dsw-alias-label-secondary)}._2kIxCW_thinkingToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}._2kIxCW_thinkingQuote ._2kIxCW_markdownPreview,._2kIxCW_thinkingQuote ._2kIxCW_markdownPayload,._2kIxCW_thinkingQuote ._2kIxCW_payload{min-height:0;color:var(--dsw-alias-label-secondary);background:0 0;padding:2px 0}._2kIxCW_assistantOutput{background:var(--dsw-alias-bg-layer-1)}._2kIxCW_markdownPreview{padding:6px 14px 8px}._2kIxCW_markdownPayload{min-height:100%;padding:14px}._2kIxCW_jsonPayload{min-height:100%}._2kIxCW_jsonPreview{min-height:0}._2kIxCW_schema{background:var(--dsw-alias-bg-layer-1);min-height:100%}._2kIxCW_schemaPreview{min-height:0}._2kIxCW_schemaIntro{padding:12px 14px 6px}._2kIxCW_schemaPreview ._2kIxCW_schemaIntro{padding-top:6px}._2kIxCW_schemaName{color:var(--dsw-alias-label-primary);font:600 12px/18px var(--ds-font-family-code);margin:0}._2kIxCW_schemaDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:2px 0 0}._2kIxCW_schemaParameters{min-width:0}._2kIxCW_schemaParametersTitle{color:var(--dsw-alias-label-tertiary);font:600 11px/16px var(--dsw-font-family);user-select:none;margin:0;padding:4px 14px 2px}._2kIxCW_schemaTree{margin:0 6px 8px 0}._2kIxCW_payload{box-sizing:border-box;overflow-wrap:anywhere;min-height:100%;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-markdown-code-block);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;margin:0;padding:14px}._2kIxCW_payloadPreview{min-height:0;padding:6px 14px 8px}._2kIxCW_sourceBlocks{box-sizing:border-box;min-height:100%;padding:12px 14px}._2kIxCW_sourceBlock+._2kIxCW_sourceBlock{margin-top:14px}._2kIxCW_sourceBlockHeader,._2kIxCW_sourceBlockJumpTarget{user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}._2kIxCW_sourceBlockJumpTarget{all:unset;cursor:pointer;user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}._2kIxCW_sourceBlockLabel{color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code)}._2kIxCW_sourceBlockJumpIcon{color:var(--dsw-alias-label-caption);flex:none}._2kIxCW_sourceBlockJumpTarget:hover ._2kIxCW_sourceBlockJumpIcon{color:var(--dsw-alias-label-primary)}._2kIxCW_sourceBlockJumpTarget:focus-visible{outline:none}._2kIxCW_sourceBlockJumpTarget:focus-visible ._2kIxCW_sourceBlockJumpIcon{color:var(--dsw-alias-state-business-primary)}._2kIxCW_sourceBlockContent{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}._2kIxCW_panelImageLink{cursor:zoom-in;border-radius:4px;width:auto;max-width:100%;display:block;overflow:hidden}._2kIxCW_panelImageLinkPreview{max-height:140px}._2kIxCW_panelImage{border-radius:inherit;background:var(--dsw-alias-bg-base);object-fit:contain;width:auto;max-width:100%;height:auto;max-height:320px;margin:0;display:block}._2kIxCW_panelImageLinkPreview ._2kIxCW_panelImage{max-height:140px}._2kIxCW_messageImages{flex-direction:column;gap:8px;margin:8px 14px 14px;display:flex}._2kIxCW_messageImagesPreview{gap:6px;margin:6px 14px 8px}._2kIxCW_assistantToolCalls{box-sizing:border-box;max-width:100%;color:var(--dsw-alias-label-secondary);font:11px/17px var(--ds-font-family-code);margin:2px 14px 12px;padding:0;list-style:none}._2kIxCW_assistantToolCallsPreview{margin-top:2px;margin-bottom:8px}._2kIxCW_assistantToolCalls li{min-width:0}._2kIxCW_assistantToolCallButton{all:unset;box-sizing:border-box;cursor:pointer;border-radius:3px;align-items:center;width:calc(100% + 4px);min-width:0;height:19px;margin-left:-4px;padding:0 4px;display:flex}._2kIxCW_assistantToolCallButton:hover{background:var(--dsw-alias-interactive-bg-hover)}._2kIxCW_assistantToolCallButton:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}._2kIxCW_assistantToolCallIcon{color:var(--dsw-alias-label-caption);flex:none;margin-right:5px}._2kIxCW_assistantToolCallButton:hover ._2kIxCW_assistantToolCallIcon,._2kIxCW_assistantToolCallButton:focus-visible ._2kIxCW_assistantToolCallIcon{color:var(--dsw-alias-label-secondary)}._2kIxCW_assistantToolCallText{white-space:nowrap;flex:1;min-width:0;display:flex;overflow:hidden}._2kIxCW_assistantToolCallName{color:var(--dsw-alias-label-secondary);flex:none;margin-right:5px;font-weight:500}._2kIxCW_assistantToolCallArgs{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._2kIxCW_systemPrompt{box-sizing:border-box}._2kIxCW_toolCatalog{min-height:100%;padding:8px 0 16px}._2kIxCW_toolCatalogItem{border-bottom:1px solid var(--dsw-alias-border-l1)}._2kIxCW_toolCatalogSummary{box-sizing:border-box;cursor:pointer;user-select:none;grid-template-columns:12px 12px max-content minmax(0,1fr);align-items:center;gap:5px;min-height:30px;padding:4px 12px;list-style:none;display:grid}._2kIxCW_toolCatalogSummary::-webkit-details-marker{display:none}._2kIxCW_toolCatalogSummary:hover{background:var(--dsw-alias-interactive-bg-hover)}._2kIxCW_toolCatalogSummary:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}._2kIxCW_toolCatalogChevron,._2kIxCW_toolCatalogIcon{color:var(--dsw-alias-label-caption)}._2kIxCW_toolCatalogChevron{transition:transform .1s var(--ds-ease-in-out)}._2kIxCW_toolCatalogItem[open] ._2kIxCW_toolCatalogChevron{transform:rotate(90deg)}._2kIxCW_toolCatalogName{color:var(--dsw-alias-label-primary);font:500 12px/18px var(--ds-font-family-code)}._2kIxCW_toolCatalogDescription{min-width:0;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._2kIxCW_toolCatalogDefinition{background:var(--dsw-alias-bg-base);padding:0 0 8px 29px}._2kIxCW_toolCatalogFullDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:0;padding:7px 14px 4px 0}._2kIxCW_toolCatalogTree{margin-left:-14px;margin-right:6px}._2kIxCW_resultBlocks{box-sizing:border-box;flex-direction:column;gap:10px;min-height:100%;padding:14px;display:flex}._2kIxCW_resultBlocksPreview{gap:6px;min-height:0;padding:6px 14px 8px}._2kIxCW_resultBlockText{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}._2kIxCW_overviewPreview ._2kIxCW_noPayload{padding:6px 14px 8px}._2kIxCW_noPayload{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:0;padding:18px 14px}@media (width<=760px){._2kIxCW_details{z-index:5;border-left-color:var(--dsw-alias-border-l3);width:min(92%,420px);max-width:92%;position:absolute;top:0;bottom:0;right:0;box-shadow:-12px 0 32px #00000024}}";
		...
		var TrajectoryTable_module_css_default = {
			"assistantOutput": "_2kIxCW_assistantOutput",
			"assistantContentRendered": "_2kIxCW_assistantContentRendered",
			"historyLoadingSpinner": "_2kIxCW_historyLoadingSpinner",
			"event": "_2kIxCW_event",
			"overviewSection": "_2kIxCW_overviewSection",
			"overviewPreview": "_2kIxCW_overviewPreview",
			"panelImageLink": "_2kIxCW_panelImageLink",
			"toolCatalogFullDescription": "_2kIxCW_toolCatalogFullDescription",
			"inlineResultText": "_2kIxCW_inlineResultText",
			"detailsLocation": "_2kIxCW_detailsLocation",
			"timestampToggle": "_2kIxCW_timestampToggle",
			"promptDiff": "_2kIxCW_promptDiff",
			"assistantVioletBright": "_2kIxCW_assistantVioletBright",
			"messageImagesPreview": "_2kIxCW_messageImagesPreview",
			"eventInner": "_2kIxCW_eventInner",
			"jsonPreview": "_2kIxCW_jsonPreview",
			"message": "_2kIxCW_message",
			"jsonPayload": "_2kIxCW_jsonPayload",
			"usageGroup": "_2kIxCW_usageGroup",
			"payload": "_2kIxCW_payload",
			"resultBlocksPreview": "_2kIxCW_resultBlocksPreview",
			"turnLabelActive": "_2kIxCW_turnLabelActive",
			"thinkingChevron": "_2kIxCW_thinkingChevron",
			"sourceBlockContent": "_2kIxCW_sourceBlockContent",
			"toolCatalogTree": "_2kIxCW_toolCatalogTree",
			"kindSlot": "_2kIxCW_kindSlot",
			"detailTabActive": "_2kIxCW_detailTabActive",
			"overviewParentLinks": "_2kIxCW_overviewParentLinks",
			"markdownPayload": "_2kIxCW_markdownPayload",
			"history-loading-spin": "_2kIxCW_history-loading-spin",
			"summaryScrollRegion": "_2kIxCW_summaryScrollRegion",
			"sourceBlocks": "_2kIxCW_sourceBlocks",
			"promptDiffLineadded": "_2kIxCW_promptDiffLineadded",
			"collapsedTurnEllipsis": "_2kIxCW_collapsedTurnEllipsis",
			"promptDiffTitle": "_2kIxCW_promptDiffTitle",
			"promptDiffLineremoved": "_2kIxCW_promptDiffLineremoved",
			"turnLabelCompact": "_2kIxCW_turnLabelCompact",
			"promptDiffSection": "_2kIxCW_promptDiffSection",
			"requestTokenDetail": "_2kIxCW_requestTokenDetail",
			"schemaTree": "_2kIxCW_schemaTree",
			"schemaParametersTitle": "_2kIxCW_schemaParametersTitle",
			"sourceBlockLabel": "_2kIxCW_sourceBlockLabel",
			"systemNeutral": "_2kIxCW_systemNeutral",
			"overview": "_2kIxCW_overview",
			"overviewHierarchyJumpIconTight": "_2kIxCW_overviewHierarchyJumpIconTight",
			"assistantToolCallArgs": "_2kIxCW_assistantToolCallArgs",
			"detailBodySummary": "_2kIxCW_detailBodySummary",
			"sourceBlock": "_2kIxCW_sourceBlock",
			"collapsedTurnContent": "_2kIxCW_collapsedTurnContent",
			"noOutputText": "_2kIxCW_noOutputText",
			"schemaParameters": "_2kIxCW_schemaParameters",
			"turnLabel": "_2kIxCW_turnLabel",
			"detailBody": "_2kIxCW_detailBody",
			"contentColumn": "_2kIxCW_contentColumn",
			"requestBoundaryControl": "_2kIxCW_requestBoundaryControl",
			"thinkingQuoteOnlyPreview": "_2kIxCW_thinkingQuoteOnlyPreview",
			"kindTagIcon": "_2kIxCW_kindTagIcon",
			"overviewTitleIcon": "_2kIxCW_overviewTitleIcon",
			"collapsedTurnText": "_2kIxCW_collapsedTurnText",
			"kindTagLabel": "_2kIxCW_kindTagLabel",
			"details": "_2kIxCW_details",
			"toolCatalogName": "_2kIxCW_toolCatalogName",
			"historyLoading": "_2kIxCW_historyLoading",
			"payloadPreview": "_2kIxCW_payloadPreview",
			"usageHeading": "_2kIxCW_usageHeading",
			"split": "_2kIxCW_split",
			"visuallyHidden": "_2kIxCW_visuallyHidden",
			"contextGreen": "_2kIxCW_contextGreen",
			"schema": "_2kIxCW_schema",
			"errorPayload": "_2kIxCW_errorPayload",
			"assistantToolCallText": "_2kIxCW_assistantToolCallText",
			"toolCatalogDefinition": "_2kIxCW_toolCatalogDefinition",
			"systemPrompt": "_2kIxCW_systemPrompt",
			"arrow": "_2kIxCW_arrow",
			"inlineResult": "_2kIxCW_inlineResult",
			"virtualSpacer": "_2kIxCW_virtualSpacer",
			"toolCallNameTypeface": "_2kIxCW_toolCallNameTypeface",
			"detailsResizeHandle": "_2kIxCW_detailsResizeHandle",
			"overviewHeading": "_2kIxCW_overviewHeading",
			"promptDiffSections": "_2kIxCW_promptDiffSections",
			"eventHeader": "_2kIxCW_eventHeader",
			"overviewTitle": "_2kIxCW_overviewTitle",
			"kindTag": "_2kIxCW_kindTag",
			"sourceBlockHeader": "_2kIxCW_sourceBlockHeader",
			"toolCatalogSummary": "_2kIxCW_toolCatalogSummary",
			"requestDetailsDot": "_2kIxCW_requestDetailsDot",
			"panelImage": "_2kIxCW_panelImage",
			"requestBoundaryControlActive": "_2kIxCW_requestBoundaryControlActive",
			"compactedSummary": "_2kIxCW_compactedSummary",
			"historyLoadButton": "_2kIxCW_historyLoadButton",
			"assistantToolCallButton": "_2kIxCW_assistantToolCallButton",
			"sourceBlockJumpTarget": "_2kIxCW_sourceBlockJumpTarget",
			"toolCatalogIcon": "_2kIxCW_toolCatalogIcon",
			"requestDetailsName": "_2kIxCW_requestDetailsName",
			"messageImages": "_2kIxCW_messageImages",
			"promptDiffLinecontext": "_2kIxCW_promptDiffLinecontext",
			"detailsHeader": "_2kIxCW_detailsHeader",
			"resultRequest": "_2kIxCW_resultRequest",
			"assistantContent": "_2kIxCW_assistantContent",
			"turnLabelFull": "_2kIxCW_turnLabelFull",
			"toolCallOnly": "_2kIxCW_toolCallOnly",
			"trajectory-table": "_2kIxCW_trajectory-table",
			"compacted": "_2kIxCW_compacted",
			"toolCatalogItem": "_2kIxCW_toolCatalogItem",
			"toolCallPayload": "_2kIxCW_toolCallPayload",
			"selectionRail": "_2kIxCW_selectionRail",
			"promptDiffLinemeta": "_2kIxCW_promptDiffLinemeta",
			"detailTabs": "_2kIxCW_detailTabs",
			"resultBlocks": "_2kIxCW_resultBlocks",
			"sourceBlockJumpIcon": "_2kIxCW_sourceBlockJumpIcon",
			"tablePane": "_2kIxCW_tablePane",
			"toolCatalogDescription": "_2kIxCW_toolCatalogDescription",
			"panelImageLinkPreview": "_2kIxCW_panelImageLinkPreview",
			"assistantToolCallName": "_2kIxCW_assistantToolCallName",
			"eventColumn": "_2kIxCW_eventColumn",
			"resultBlockText": "_2kIxCW_resultBlockText",
			"overviewSections": "_2kIxCW_overviewSections",
			"historyLoadRow": "_2kIxCW_historyLoadRow",
			"schemaDescription": "_2kIxCW_schemaDescription",
			"thinkingToggle": "_2kIxCW_thinkingToggle",
			"assistantToolCallIcon": "_2kIxCW_assistantToolCallIcon",
			"schemaName": "_2kIxCW_schemaName",
			"schemaIntro": "_2kIxCW_schemaIntro",
			"detailsTitle": "_2kIxCW_detailsTitle",
			"schemaPreview": "_2kIxCW_schemaPreview",
			"noPayload": "_2kIxCW_noPayload",
			"content": "_2kIxCW_content",
			"thinkingQuote": "_2kIxCW_thinkingQuote",
			"toolCatalog": "_2kIxCW_toolCatalog",
			"contentText": "_2kIxCW_contentText",
			"historyLoadingBar": "_2kIxCW_historyLoadingBar",
			"detailTab": "_2kIxCW_detailTab",
			"assistantToolCallsPreview": "_2kIxCW_assistantToolCallsPreview",
			"toolAmber": "_2kIxCW_toolAmber",
			"usagePanel": "_2kIxCW_usagePanel",
			"table": "_2kIxCW_table",
			"user": "_2kIxCW_user",
			"overviewHierarchyNavLink": "_2kIxCW_overviewHierarchyNavLink",
			"markdownPreview": "_2kIxCW_markdownPreview",
			"error": "_2kIxCW_error",
			"subtoolAmber": "_2kIxCW_subtoolAmber",
			"toolCatalogChevron": "_2kIxCW_toolCatalogChevron",
			"resultPreview": "_2kIxCW_resultPreview",
			"close": "_2kIxCW_close",
			"turnRail": "_2kIxCW_turnRail",
			"assistantToolCalls": "_2kIxCW_assistantToolCalls"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-trajectory\src\client\TrajectoryToolbar.module.css.mjs
		const css$2 = "._6A9TPW_root{z-index:4;box-sizing:border-box;width:100%;height:var(--dsh-trajectory-toolbar-height);border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);position:sticky;top:0}._6A9TPW_inner{box-sizing:border-box;align-items:center;gap:8px;width:100%;height:100%;padding:0 6px;display:flex}._6A9TPW_actions{flex:none;align-items:center;gap:2px;display:flex}._6A9TPW_toggle{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 7px;display:inline-flex}._6A9TPW_toggle:hover,._6A9TPW_toggle[aria-pressed=true]{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}._6A9TPW_toggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}._6A9TPW_toggleIcon{stroke:currentColor;stroke-width:1.25px;stroke-linecap:round;stroke-linejoin:round;flex:none;width:12px;height:12px}._6A9TPW_control{box-sizing:border-box;width:88px;height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:0;flex:none;justify-content:center;align-items:center;gap:4px;padding:0 5px;display:inline-flex}._6A9TPW_control[hidden]{display:none}._6A9TPW_control:hover:not(:disabled),._6A9TPW_control[aria-checked=true],._6A9TPW_control[aria-pressed=true]{color:var(--dsw-alias-label-primary)}._6A9TPW_control:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}._6A9TPW_control:disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}._6A9TPW_controlTrack{background:var(--dsw-alias-border-l2);width:20px;height:10px;transition:background-color .12s var(--ds-ease-in-out);border-radius:5px;flex:none;display:inline-block;position:relative}._6A9TPW_controlThumb{background:var(--dsw-alias-bg-layer-1);width:6px;height:6px;transition:transform .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:2px;left:2px}._6A9TPW_controlTrack[data-on=true]{background:var(--dsw-alias-state-business-primary)}._6A9TPW_controlTrack[data-on=true] ._6A9TPW_controlThumb{transform:translate(10px)}._6A9TPW_action{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 5px;display:inline-flex}._6A9TPW_action:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}._6A9TPW_action:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}._6A9TPW_actionIcon{color:var(--dsw-alias-label-tertiary);font:14px/14px var(--ds-font-family-code)}._6A9TPW_search{border:1px solid var(--dsw-alias-border-l2);min-width:84px;height:22px;color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-layer-2);border-radius:4px;flex:0 164px;align-items:center;gap:4px;margin-left:auto;padding:0 6px;display:flex}._6A9TPW_search:hover{border-color:var(--dsw-alias-label-caption)}._6A9TPW_search:focus-within{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-layer-1)}._6A9TPW_searchIcon{flex:none}._6A9TPW_searchInput{width:100%;min-width:0;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);background:0 0;border:0;outline:0;padding:0}._6A9TPW_searchInput::placeholder{color:var(--dsw-alias-label-caption)}._6A9TPW_searchInput::-webkit-search-cancel-button{cursor:pointer;width:12px;height:12px}";
		...
		var TrajectoryToolbar_module_css_default = {
			"actionIcon": "_6A9TPW_actionIcon",
			"root": "_6A9TPW_root",
			"actions": "_6A9TPW_actions",
			"action": "_6A9TPW_action",
			"searchInput": "_6A9TPW_searchInput",
			"controlTrack": "_6A9TPW_controlTrack",
			"inner": "_6A9TPW_inner",
			"toggle": "_6A9TPW_toggle",
			"searchIcon": "_6A9TPW_searchIcon",
			"search": "_6A9TPW_search",
			"control": "_6A9TPW_control",
			"controlThumb": "_6A9TPW_controlThumb",
			"toggleIcon": "_6A9TPW_toggleIcon"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-trajectory\src\client\TrajectoryTimeline.module.css.mjs
		const css$1 = "._9Kx7Rq_root{z-index:1;isolation:isolate;border-bottom:1px solid var(--dsw-alias-border-l2);user-select:none;flex:none;position:relative}._9Kx7Rq_root [role=tooltip]{font:var(--dsw-font-xxxs-11)}._9Kx7Rq_plot{background:var(--dsw-alias-bg-layer-2);grid-template-columns:44px minmax(0,1fr);height:50px;display:grid;overflow:hidden}._9Kx7Rq_labels{border-right:1px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);font-size:10px;line-height:1;position:relative}._9Kx7Rq_labels span{text-align:right;justify-content:flex-end;align-items:center;height:8px;display:flex;position:absolute;right:3px}._9Kx7Rq_labels span:first-child{top:7px}._9Kx7Rq_labels span:nth-child(2){top:21px}._9Kx7Rq_labels span:nth-child(3){top:35px}._9Kx7Rq_track{cursor:crosshair;touch-action:none;position:relative;overflow:hidden}._9Kx7Rq_track[data-panning=true]{cursor:grabbing}._9Kx7Rq_earlierHistory{z-index:5;appearance:none;box-sizing:border-box;background:linear-gradient(to right, var(--dsw-alias-bg-layer-2) 0, var(--dsw-alias-bg-layer-2) 38%, transparent 100%);width:28px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);opacity:.72;cursor:pointer;border:0;outline:none;justify-content:flex-start;align-items:center;padding-left:3px;line-height:1;display:flex;position:absolute;top:0;bottom:0;left:0}._9Kx7Rq_earlierHistory:hover{opacity:1}._9Kx7Rq_earlierHistory[aria-disabled=true]{cursor:default}._9Kx7Rq_earlierHistory:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-border-l2)}._9Kx7Rq_empty{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}._9Kx7Rq_track:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}._9Kx7Rq_lanes{z-index:2;top:7px;bottom:7px;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);position:absolute}._9Kx7Rq_turnBoundaries{z-index:3;top:0;bottom:0;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);pointer-events:none;position:absolute}@media (prefers-reduced-motion:no-preference){._9Kx7Rq_lanes[data-animate-viewport=true],._9Kx7Rq_turnBoundaries[data-animate-viewport=true]{transition:left .18s ease-out}}._9Kx7Rq_turnBoundary{top:0;bottom:0;left:var(--trajectory-turn-left);background:var(--dsw-alias-border-l2);width:1px;position:absolute}._9Kx7Rq_span{top:calc(var(--trajectory-span-lane) * 14px);left:calc(var(--trajectory-span-left) + var(--trajectory-span-gap));width:max(2px, calc(var(--trajectory-span-width) - var(--trajectory-span-gap) - var(--trajectory-span-gap)));background:var(--dsw-alias-label-secondary);opacity:.78;border-radius:1px;min-width:2px;height:8px;position:absolute}._9Kx7Rq_span[data-timeline-span=user]{background:var(--dsw-alias-state-business-primary)}._9Kx7Rq_span[data-timeline-span=context]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary))}._9Kx7Rq_span[data-timeline-span=message]{--trajectory-assistant-decoding-color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));--trajectory-assistant-ttft-color:color-mix(in srgb, var(--trajectory-assistant-decoding-color) 54%, var(--dsw-alias-bg-layer-2));background:var(--trajectory-assistant-decoding-color);opacity:1}._9Kx7Rq_span[data-timeline-span=message][data-assistant-timing=true]{background:linear-gradient(to right, var(--trajectory-assistant-ttft-color) 0, var(--trajectory-assistant-ttft-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) 100%)}._9Kx7Rq_span[data-timeline-span=tool],._9Kx7Rq_span[data-timeline-span=subtool]{background:var(--dsw-alias-state-warn-label);opacity:1}._9Kx7Rq_span[data-error=true]{background:var(--dsw-alias-state-error-primary)}._9Kx7Rq_span[data-equal-duration=true]{width:8px;min-width:8px}._9Kx7Rq_span[data-selected=false]{opacity:.2}._9Kx7Rq_span[data-hovered=true]:not([data-current=true]){z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 80%, transparent)}._9Kx7Rq_span[data-current=true]{z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px var(--dsw-alias-state-business-primary)}._9Kx7Rq_span[data-search-match=false]{opacity:.14}._9Kx7Rq_selection{z-index:1;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, transparent);min-width:1px;box-shadow:-100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent), 100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent);pointer-events:none;position:absolute}._9Kx7Rq_selectionEdges{z-index:4;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);pointer-events:none;min-width:1px;position:absolute}._9Kx7Rq_hoverLine{z-index:4;top:0;bottom:0;left:clamp(0px, calc(var(--trajectory-hover-left) - 1px), calc(100% - 2px));background:var(--dsw-alias-state-business-primary);pointer-events:none;width:2px;position:absolute}._9Kx7Rq_selectionEdges:before,._9Kx7Rq_selectionEdges:after{background:var(--dsw-alias-state-business-primary);content:\"\";width:3px;position:absolute;top:0;bottom:0}._9Kx7Rq_selectionEdges:before{left:0}._9Kx7Rq_selectionEdges:after{right:0}._9Kx7Rq_selectionEdges[data-dragging=true]:before,._9Kx7Rq_selectionEdges[data-dragging=true]:after{width:2px}._9Kx7Rq_selection[data-dragging=true]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}";
		...
		var TrajectoryTimeline_module_css_default = {
			"root": "_9Kx7Rq_root",
			"turnBoundaries": "_9Kx7Rq_turnBoundaries",
			"plot": "_9Kx7Rq_plot",
			"labels": "_9Kx7Rq_labels",
			"turnBoundary": "_9Kx7Rq_turnBoundary",
			"empty": "_9Kx7Rq_empty",
			"span": "_9Kx7Rq_span",
			"selectionEdges": "_9Kx7Rq_selectionEdges",
			"hoverLine": "_9Kx7Rq_hoverLine",
			"earlierHistory": "_9Kx7Rq_earlierHistory",
			"lanes": "_9Kx7Rq_lanes",
			"track": "_9Kx7Rq_track",
			"selection": "_9Kx7Rq_selection"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-trajectory\src\client\views.module.css.mjs
		const css = "._8LMWCa_root{--dsh-trajectory-toolbar-height:32px;box-sizing:border-box;width:100%;height:100%;min-height:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);flex-direction:column;display:flex;overflow:hidden}._8LMWCa_ledger{z-index:0;isolation:isolate;--dsh-trajectory-bottom-clearance:calc(var(--dsh-composer-height,152px) + 16px);flex:1;min-width:0;min-height:0;display:flex;position:relative;overflow:hidden}";
