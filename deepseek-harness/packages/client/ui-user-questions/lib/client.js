window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-user-questions\src\client\PlanReviewPanel.module.css.mjs
		const css$1 = ".ZpTTJa_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.ZpTTJa_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-state-warn-secondary);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;display:flex;overflow:hidden}.ZpTTJa_card,.ZpTTJa_card *{box-sizing:border-box}.ZpTTJa_strip{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-primary);flex-shrink:0;align-items:center;gap:8px;padding:10px 16px;font-size:13px;line-height:18px;display:flex}.ZpTTJa_dot{background:var(--dsw-alias-state-warn-primary);border-radius:50%;width:8px;height:8px}.ZpTTJa_body{overscroll-behavior:contain;flex:auto;min-height:0;padding:12px 16px 4px;font-size:14px;line-height:22px;overflow-y:auto}.ZpTTJa_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;padding:8px 16px 12px;display:flex}.ZpTTJa_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);font-size:11px;line-height:16px}.ZpTTJa_actions{flex-shrink:0;align-items:center;gap:8px;display:flex}.ZpTTJa_discuss{color:var(--dsw-alias-label-secondary);gap:6px}.ZpTTJa_discuss:hover:not(:disabled){color:var(--dsw-alias-label-primary)}@media (width<=720px){.ZpTTJa_card{border-radius:16px}.ZpTTJa_body{padding:10px 12px 4px}.ZpTTJa_footer{align-items:flex-end;padding:8px 12px 10px}}";
		...
		var PlanReviewPanel_module_css_default = {
			"footer": "ZpTTJa_footer",
			"frame": "ZpTTJa_frame",
			"strip": "ZpTTJa_strip",
			"discuss": "ZpTTJa_discuss",
			"actions": "ZpTTJa_actions",
			"dot": "ZpTTJa_dot",
			"card": "ZpTTJa_card",
			"feedback": "ZpTTJa_feedback",
			"body": "ZpTTJa_body"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-user-questions\src\client\QuestionComposer.module.css.mjs
		const css = ".ZgRm9W_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.ZgRm9W_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;padding:0 0 10px;display:flex;overflow:hidden}.ZgRm9W_card,.ZgRm9W_card *{box-sizing:border-box}.ZgRm9W_header{flex-shrink:0;justify-content:space-between;align-items:flex-start;gap:16px;padding:20px 16px 0 24px;display:flex}.ZgRm9W_headingBlock{min-width:0}.ZgRm9W_eyebrow{color:var(--dsw-alias-label-tertiary);margin-bottom:5px;font-size:11px;line-height:16px}.ZgRm9W_title{margin:0;font-size:16px;font-weight:500;line-height:22px}.ZgRm9W_detail{margin:0 2px 8px}.ZgRm9W_footerActions{flex-shrink:0;align-items:center;gap:12px;display:flex}.ZgRm9W_pager{flex-shrink:0;align-items:center;gap:6px;display:flex}.ZgRm9W_progress{color:var(--dsw-alias-label-secondary);white-space:nowrap;word-spacing:-2px;padding:0 4px;font-size:14px;font-weight:500;line-height:24px}.ZgRm9W_iconButton{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;place-items:center;padding:0;display:grid}.ZgRm9W_iconButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.ZgRm9W_iconButton:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.ZgRm9W_body{overscroll-behavior:contain;flex-direction:column;flex:auto;min-height:0;display:flex;overflow-y:auto}.ZgRm9W_options{flex-direction:column;gap:1px;margin:8px 0 0;padding:4px 12px;display:flex}.ZgRm9W_option{width:100%;min-height:40px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.ZgRm9W_option:hover:not(:disabled),.ZgRm9W_optionSelected{background:var(--dsw-alias-interactive-bg-hover)}.ZgRm9W_optionSelected{border-color:var(--dsw-alias-border-l2)}.ZgRm9W_option:disabled{cursor:default}.ZgRm9W_number{background:var(--dsw-alias-bg-overlay);width:20px;height:20px;color:var(--dsw-alias-label-secondary);border-radius:6px;flex:0 0 20px;place-items:center;margin-top:2px;font-size:12px;font-weight:500;line-height:18px;display:grid}.ZgRm9W_checkbox{flex:0 0 20px;place-items:center;width:20px;height:20px;margin-top:2px;display:grid}.ZgRm9W_checkbox:before{content:\"\";border:1px solid var(--dsw-alias-border-l4);border-radius:4px;grid-area:1/1;width:14px;height:14px;transition:background-color .12s,border-color .12s}.ZgRm9W_checkbox>svg{grid-area:1/1}.ZgRm9W_checkboxChecked{color:var(--dsw-alias-label-primary-foreground)}.ZgRm9W_checkboxChecked:before{border-color:var(--dsw-alias-label-primary);background:var(--dsw-alias-label-primary)}.ZgRm9W_optionCopy{flex:1;min-width:0}.ZgRm9W_optionLine{flex-wrap:wrap;align-items:baseline;gap:2px 6px;display:flex}.ZgRm9W_optionLabel{font-size:14px;font-weight:500;line-height:24px}.ZgRm9W_badge{background:var(--dsw-specific-sidebar-nav-item-active-accent);color:var(--dsw-alias-button-info-fill);border-radius:6px;padding:0 4px;font-size:11px;font-weight:600;line-height:18px}.ZgRm9W_description{color:var(--dsw-alias-label-tertiary);font-size:14px;font-weight:400;line-height:24px}.ZgRm9W_customRow{border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;width:100%;min-height:40px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.ZgRm9W_customRow:hover,.ZgRm9W_customRow:focus-within,.ZgRm9W_customRowActive{background:var(--dsw-alias-interactive-bg-hover)}.ZgRm9W_customRow:focus-within,.ZgRm9W_customRowActive{border-color:var(--dsw-alias-border-l2)}.ZgRm9W_customInput{min-width:0;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);font:inherit;background:0 0;border:none;outline:none;flex:1;padding:0;font-size:14px;line-height:24px}.ZgRm9W_customInput::placeholder{color:var(--dsw-alias-label-caption)}.ZgRm9W_customTextarea{resize:none;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);min-height:64px;max-height:140px;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);font:inherit;border-radius:10px;outline:none;flex-shrink:0;margin:0 12px;padding:8px 12px;font-size:14px;line-height:24px;display:block}.ZgRm9W_customTextarea:focus{border-color:var(--dsw-alias-state-business-primary)}.ZgRm9W_customTextarea::placeholder{color:var(--dsw-alias-label-caption)}.ZgRm9W_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;margin-top:12px;padding:0 10px 0 18px;display:flex}.ZgRm9W_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);text-align:right;flex:1;font-size:11px;line-height:16px}@media (width<=720px){.ZgRm9W_card{border-radius:16px}.ZgRm9W_header{padding:10px 12px 0 18px}.ZgRm9W_options{padding:4px 8px}.ZgRm9W_title{font-size:15px;line-height:21px}.ZgRm9W_option,.ZgRm9W_customRow{padding:8px 6px}.ZgRm9W_footer{align-items:flex-end;padding:0 10px}.ZgRm9W_footerActions{flex-shrink:0}}@media (prefers-reduced-motion:reduce){.ZgRm9W_option,.ZgRm9W_customRow{transition:none}}";
		...
		var QuestionComposer_module_css_default = {
			"detail": "ZgRm9W_detail",
			"title": "ZgRm9W_title",
			"checkbox": "ZgRm9W_checkbox",
			"customTextarea": "ZgRm9W_customTextarea",
			"progress": "ZgRm9W_progress",
			"optionCopy": "ZgRm9W_optionCopy",
			"optionLabel": "ZgRm9W_optionLabel",
			"headingBlock": "ZgRm9W_headingBlock",
			"card": "ZgRm9W_card",
			"header": "ZgRm9W_header",
			"pager": "ZgRm9W_pager",
			"badge": "ZgRm9W_badge",
			"checkboxChecked": "ZgRm9W_checkboxChecked",
			"optionLine": "ZgRm9W_optionLine",
			"iconButton": "ZgRm9W_iconButton",
			"body": "ZgRm9W_body",
			"description": "ZgRm9W_description",
			"customInput": "ZgRm9W_customInput",
			"eyebrow": "ZgRm9W_eyebrow",
			"footerActions": "ZgRm9W_footerActions",
			"optionSelected": "ZgRm9W_optionSelected",
			"customRow": "ZgRm9W_customRow",
			"option": "ZgRm9W_option",
			"frame": "ZgRm9W_frame",
			"options": "ZgRm9W_options",
			"number": "ZgRm9W_number",
			"customRowActive": "ZgRm9W_customRowActive",
			"feedback": "ZgRm9W_feedback",
			"footer": "ZgRm9W_footer"
		};
		//#endregion
