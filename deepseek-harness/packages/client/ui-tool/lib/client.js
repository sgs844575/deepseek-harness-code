window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-tool\src\client\tool\components\ToolRow.module.css.mjs
		const css$3 = ".Od_U3q_root{flex-direction:column;display:flex}.Od_U3q_row{position:relative;overflow:hidden}.Od_U3q_root[data-state=running] .Od_U3q_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite Od_U3q_dsh-tool-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes Od_U3q_dsh-tool-row-sweep{0%{left:-300px}90%,to{left:100%}}.Od_U3q_leading{flex-shrink:0}.Od_U3q_root[data-tool^=cordis_] .Od_U3q_leading,.Od_U3q_root[data-tool^=cordis_] .Od_U3q_title{color:var(--dsw-alias-state-business-primary)}.Od_U3q_root[data-tool^=cordis_] .Od_U3q_title{font-weight:500}.Od_U3q_root[data-tool^=cordis_] .Od_U3q_sep{background:var(--dsw-alias-state-business-primary)}.Od_U3q_chevron{color:var(--dsw-alias-label-secondary)}.Od_U3q_title{font-weight:400}.Od_U3q_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.Od_U3q_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.Od_U3q_summarySuffix{white-space:nowrap;color:var(--dsw-alias-label-tertiary);flex:none;margin-left:4px;font-size:14px;line-height:24px}.Od_U3q_fileLink{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:inherit;text-align:left;color:var(--dsw-alias-label-secondary);text-decoration:underline;text-decoration-color:var(--dsw-alias-label-quaternary);text-underline-offset:3px;cursor:pointer;background:0 0;border:none;flex:auto;margin:0;padding:0;font-size:14px;line-height:24px;overflow:hidden}.Od_U3q_fileLink:hover{color:var(--dsw-alias-label-primary);text-decoration-color:currentColor}.Od_U3q_errorSummary{color:var(--dsw-alias-state-error-primary)}.Od_U3q_bodyWrap{flex-direction:column;display:flex}.Od_U3q_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.Od_U3q_root:hover .Od_U3q_inspectButton,.Od_U3q_inspectButton:focus-visible{opacity:1}.Od_U3q_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.Od_U3q_bodyScroll{max-height:260px;overflow-y:auto}.Od_U3q_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.Od_U3q_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.Od_U3q_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.Od_U3q_ioSection::-webkit-scrollbar-track{margin:6px 0}.Od_U3q_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.Od_U3q_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.Od_U3q_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.Od_U3q_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.Od_U3q_codeBody,.Od_U3q_terminalBody,.Od_U3q_diffBody,.Od_U3q_readBody,.Od_U3q_searchBody,.Od_U3q_webBody{margin:4px 0 4px 4px}.Od_U3q_searchRecovery{white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);margin:4px 0 4px 4px}.Od_U3q_codeBody{--dsl-code-block-content-font:var(--dsw-font-markdown-code-block-small)}.Od_U3q_terminalBody{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1)}.Od_U3q_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var ToolRow_module_css_default = {
			"ioText": "Od_U3q_ioText",
			"dsh-tool-row-sweep": "Od_U3q_dsh-tool-row-sweep",
			"errorSummary": "Od_U3q_errorSummary",
			"ioSection": "Od_U3q_ioSection",
			"ioDivider": "Od_U3q_ioDivider",
			"diffBody": "Od_U3q_diffBody",
			"summary": "Od_U3q_summary",
			"visuallyHidden": "Od_U3q_visuallyHidden",
			"readBody": "Od_U3q_readBody",
			"sep": "Od_U3q_sep",
			"bodyWrap": "Od_U3q_bodyWrap",
			"root": "Od_U3q_root",
			"row": "Od_U3q_row",
			"bodyScroll": "Od_U3q_bodyScroll",
			"searchBody": "Od_U3q_searchBody",
			"leading": "Od_U3q_leading",
			"title": "Od_U3q_title",
			"codeBody": "Od_U3q_codeBody",
			"searchRecovery": "Od_U3q_searchRecovery",
			"fileLink": "Od_U3q_fileLink",
			"ioCard": "Od_U3q_ioCard",
			"inspectButton": "Od_U3q_inspectButton",
			"ioLabel": "Od_U3q_ioLabel",
			"summarySuffix": "Od_U3q_summarySuffix",
			"terminalBody": "Od_U3q_terminalBody",
			"webBody": "Od_U3q_webBody",
			"chevron": "Od_U3q_chevron"
		};
		//#endregion
		...
		*  summary already describe a settled row). */
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-tool\src\client\tool\ToolCallTree.module.css.mjs
		const css$2 = ".qa1Spq_callRow{border-radius:6px}.qa1Spq_subCalls{border-left:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;margin:4px 0 2px 22px;padding-left:8px;display:flex}";
		...
		var ToolCallTree_module_css_default = {
			"callRow": "qa1Spq_callRow",
			"subCalls": "qa1Spq_subCalls"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-tool\src\client\tool\ToolDetails.module.css.mjs
		const css$1 = ".bYW77G_description{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);margin:0 0 6px}.bYW77G_cardBody{margin:0}.bYW77G_recovery{white-space:pre-wrap;overflow-wrap:anywhere;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:6px 0 0}.bYW77G_code{background:var(--dsw-alias-markdown-code-block);font-family:var(--ds-font-family-code);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:12px;margin:0;padding:16px;font-size:13px;line-height:22px}.bYW77G_code[data-error]{color:var(--dsw-alias-state-error-primary)}.bYW77G_read,.bYW77G_web{margin:0}.bYW77G_empty{color:var(--dsw-alias-label-tertiary);padding:8px 0;font-size:13px;line-height:20px}";
		...
		var ToolDetails_module_css_default = {
			...
			"code": "bYW77G_code",
			"empty": "bYW77G_empty",
			"cardBody": "bYW77G_cardBody",
			"recovery": "bYW77G_recovery",
			"description": "bYW77G_description"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-tool\src\client\tool\toolviews\bash-sample.module.css.mjs
		const css = "._6DI-dW_card{flex-direction:column;display:flex}._6DI-dW_terminal{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1);margin:4px 0 4px 4px}._6DI-dW_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}._6DI-dW_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}._6DI-dW_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}._6DI-dW_ioSection::-webkit-scrollbar-track{margin:6px 0}._6DI-dW_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}._6DI-dW_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}._6DI-dW_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}._6DI-dW_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}._6DI-dW_root[data-expandable]{cursor:pointer}._6DI-dW_root{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}._6DI-dW_root[data-state=running]:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite _6DI-dW_dsh-bash-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes _6DI-dW_dsh-bash-row-sweep{0%{left:-300px}90%,to{left:100%}}._6DI-dW_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}._6DI-dW_chevron{color:var(--dsw-alias-label-secondary)}._6DI-dW_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}._6DI-dW_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}._6DI-dW_root:hover ._6DI-dW_iconIdle{opacity:0}._6DI-dW_root:hover ._6DI-dW_chevronHover{opacity:1}._6DI-dW_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}._6DI-dW_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}._6DI-dW_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}._6DI-dW_errorSummary{color:var(--dsw-alias-state-error-primary)}._6DI-dW_bodyWrap{flex-direction:column;display:flex}._6DI-dW_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}._6DI-dW_card:hover ._6DI-dW_inspectButton,._6DI-dW_inspectButton:focus-visible{opacity:1}._6DI-dW_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}._6DI-dW_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var bash_sample_module_css_default = {
			"ioLabel": "_6DI-dW_ioLabel",
			"card": "_6DI-dW_card",
			"leading": "_6DI-dW_leading",
			"visuallyHidden": "_6DI-dW_visuallyHidden",
			"root": "_6DI-dW_root",
			"iconIdle": "_6DI-dW_iconIdle",
			"terminal": "_6DI-dW_terminal",
			"bodyWrap": "_6DI-dW_bodyWrap",
			"title": "_6DI-dW_title",
			"sep": "_6DI-dW_sep",
			"inspectButton": "_6DI-dW_inspectButton",
			"chevronHover": "_6DI-dW_chevronHover",
			"dsh-bash-row-sweep": "_6DI-dW_dsh-bash-row-sweep",
			"summary": "_6DI-dW_summary",
			"chevron": "_6DI-dW_chevron",
			"ioCard": "_6DI-dW_ioCard",
			"ioDivider": "_6DI-dW_ioDivider",
			"ioText": "_6DI-dW_ioText",
			"ioSection": "_6DI-dW_ioSection",
			"errorSummary": "_6DI-dW_errorSummary"
		};
		//#endregion
