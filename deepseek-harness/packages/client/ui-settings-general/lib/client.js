window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-settings-general\src\client\SettingsRoot.module.css.mjs
		const css$3 = "._6OP20a_trigger{box-sizing:border-box;cursor:pointer;width:calc(100% + 8px);height:34px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:12px;flex:none;align-items:center;gap:8px;margin:4px -4px;padding:6px 2px 6px 10px;font-family:inherit;font-size:14px;line-height:22px;display:flex;overflow:hidden}._6OP20a_trigger:hover{background:var(--dsw-alias-interactive-bg-hover)}._6OP20a_trigger._6OP20a_rail{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;margin:8px 0 10px;padding:0}._6OP20a_triggerLabel{white-space:nowrap;overflow:hidden}._6OP20a_overlay{z-index:1000;justify-content:center;align-items:center;display:flex;position:fixed;inset:0}._6OP20a_mask{background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);position:absolute;inset:0}._6OP20a_panel{z-index:1;background:var(--dsw-alias-bg-layer-2);width:800px;max-width:calc(100vw - 48px);height:min(800px,100vh - 48px);box-shadow:var(--dsw-shadow-lv3);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:24px;display:flex;position:relative;overflow:hidden}._6OP20a_nav{box-sizing:border-box;flex-direction:column;flex:none;gap:18px;width:188px;padding:22px 12px 0;display:flex}._6OP20a_navTitle{color:var(--dsw-alias-label-primary);padding:0 12px;font-size:16px;font-weight:500;line-height:24px}._6OP20a_navList{flex-direction:column;gap:4px;display:flex}._6OP20a_navCell{box-sizing:border-box;cursor:pointer;height:40px;color:var(--dsw-alias-label-primary);text-align:left;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;padding:9px 16px 9px 12px;font-family:inherit;font-size:14px;font-weight:400;line-height:22px;display:flex}._6OP20a_navCell:hover{background:var(--dsw-specific-sidebar-nav-item-hover)}._6OP20a_navCell._6OP20a_active{background:var(--dsw-specific-sidebar-nav-item-active)}._6OP20a_navIcon{flex:none}._6OP20a_navLabel{white-space:nowrap;text-overflow:ellipsis;flex:1;min-width:0;overflow:hidden}._6OP20a_content{flex-direction:column;flex:1;min-width:0;display:flex}._6OP20a_header{box-sizing:border-box;flex:none;justify-content:space-between;align-items:flex-start;gap:8px;height:54px;padding:20px 14px 8px 10px;display:flex}._6OP20a_actions{justify-content:flex-end;align-items:center;gap:8px;min-width:0;margin-left:auto;display:flex}._6OP20a_close{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:0;display:inline-flex}._6OP20a_close:hover{background:var(--dsw-alias-interactive-bg-hover)}._6OP20a_options{flex:1;min-height:0;padding:0 24px 24px;overflow-y:auto}._6OP20a_hiddenLabel{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var SettingsRoot_module_css_default = {
			"navCell": "_6OP20a_navCell",
			"header": "_6OP20a_header",
			"rail": "_6OP20a_rail",
			"panel": "_6OP20a_panel",
			"overlay": "_6OP20a_overlay",
			"navLabel": "_6OP20a_navLabel",
			"active": "_6OP20a_active",
			"trigger": "_6OP20a_trigger",
			"triggerLabel": "_6OP20a_triggerLabel",
			"navTitle": "_6OP20a_navTitle",
			"actions": "_6OP20a_actions",
			"options": "_6OP20a_options",
			"hiddenLabel": "_6OP20a_hiddenLabel",
			"content": "_6OP20a_content",
			"mask": "_6OP20a_mask",
			"nav": "_6OP20a_nav",
			"navList": "_6OP20a_navList",
			"navIcon": "_6OP20a_navIcon",
			"close": "_6OP20a_close"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-settings-general\src\client\chrome.module.css.mjs
		const css$2 = ".Wnd12G_triggerLabel{white-space:nowrap;overflow:hidden}";
		...
		var chrome_module_css_default = { "triggerLabel": "Wnd12G_triggerLabel" };
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-settings-general\src\client\GeneralSection.module.css.mjs
		const css$1 = "._u588G_section{flex-direction:column;width:100%;display:flex}._u588G_section>[data-slot=\"settings.general.item\"]>:last-child{border-bottom:none}";
		...
		var GeneralSection_module_css_default = { "section": "_u588G_section" };
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-settings-general\src\client\SettingsDocumentAction.module.css.mjs
		const css = ".PS6s0q_action{align-items:center;gap:8px;min-width:0;display:flex}.PS6s0q_error{max-width:180px;color:var(--dsw-alias-state-error-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}";
