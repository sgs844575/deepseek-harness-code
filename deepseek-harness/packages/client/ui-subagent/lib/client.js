window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-subagent\src\client\SubagentCatalogAction.module.css.mjs
		const css$1 = ".OfmWza_root{position:relative}.OfmWza_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:3px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.OfmWza_count{margin:0 5px}.OfmWza_activitySlot{flex:none;width:10px;height:10px;display:inline-flex}.OfmWza_trigger:hover,.OfmWza_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.OfmWza_trigger svg{transition:transform .12s}.OfmWza_triggerOpen{transform:rotate(180deg)}.OfmWza_menu{z-index:100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);width:336px;max-width:min(400px,100vw - 32px);max-height:min(560px,100vh - 140px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;top:calc(100% + 5px);left:0;overflow:auto}.OfmWza_node{min-width:0;position:relative}.OfmWza_menu>.OfmWza_node{margin-left:-3px}.OfmWza_row{box-sizing:border-box;width:100%;min-height:50px;color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;outline:none;align-items:flex-start;gap:8px;padding:7px 8px 7px 11px;font-size:13px;line-height:18px;display:flex;position:relative}.OfmWza_row:hover>.OfmWza_clickarea,.OfmWza_row:focus-visible>.OfmWza_clickarea{background:var(--dsw-alias-interactive-bg-hover)}.OfmWza_clickarea{box-sizing:border-box;border-radius:8px;flex:1;align-self:stretch;align-items:flex-start;gap:8px;min-width:0;margin:-7px -8px;padding:7px 8px;display:flex}.OfmWza_row>[data-state],.OfmWza_clickarea>[data-state]{margin-top:4px}.OfmWza_disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.OfmWza_disabled:hover{background:0 0}.OfmWza_loadingRow{cursor:default}.OfmWza_disclosure,.OfmWza_disclosureSpace{flex:none;width:14px;height:18px}.OfmWza_disclosure{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;justify-content:center;align-items:center;padding:0;transition:transform .12s;display:inline-flex}.OfmWza_disclosure:hover{color:var(--dsw-alias-label-primary)}.OfmWza_disclosureOpen{transform:rotate(90deg)}.OfmWza_content{flex-direction:column;flex:1;min-width:0;display:flex}.OfmWza_label,.OfmWza_summary{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.OfmWza_label{color:inherit;font-weight:400}.OfmWza_summary,.OfmWza_metrics{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.OfmWza_metrics{font-variant-numeric:tabular-nums;text-align:right;white-space:nowrap;flex:none;grid-template-rows:18px 16px;display:grid}.OfmWza_metricToken{grid-row:1;line-height:18px}.OfmWza_metricDuration{grid-row:2}.OfmWza_children{margin-left:18px;padding-left:4px;position:relative}.OfmWza_children:before,.OfmWza_children>.OfmWza_node:before{content:\"\";border-left:1px solid var(--dsw-alias-border-l2);position:absolute;left:0}.OfmWza_children:before{height:26px;top:-26px}.OfmWza_children[aria-busy=true]:before{content:none}.OfmWza_children>.OfmWza_node:before{top:0;bottom:0;left:-4px}.OfmWza_children>.OfmWza_node:last-child:before{height:17px;bottom:auto}.OfmWza_children>.OfmWza_node>.OfmWza_row:before{content:\"\";border-top:1px solid var(--dsw-alias-border-l2);width:14px;position:absolute;top:16px;left:-4px}.OfmWza_notice,.OfmWza_error{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.OfmWza_error{color:var(--dsw-alias-state-error-primary);justify-content:space-between;align-items:center;gap:12px;display:flex}.OfmWza_refresh{color:inherit;cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;align-items:center;gap:4px;padding:4px 6px;display:inline-flex}.OfmWza_refresh:hover{background:var(--dsw-alias-interactive-bg-hover)}";
		...
		var SubagentCatalogAction_module_css_default = {
			"clickarea": "OfmWza_clickarea",
			"trigger": "OfmWza_trigger",
			"summary": "OfmWza_summary",
			"triggerOpen": "OfmWza_triggerOpen",
			"row": "OfmWza_row",
			"activitySlot": "OfmWza_activitySlot",
			"loadingRow": "OfmWza_loadingRow",
			"disclosure": "OfmWza_disclosure",
			"disclosureSpace": "OfmWza_disclosureSpace",
			"metricToken": "OfmWza_metricToken",
			"disclosureOpen": "OfmWza_disclosureOpen",
			"children": "OfmWza_children",
			"count": "OfmWza_count",
			"menu": "OfmWza_menu",
			"node": "OfmWza_node",
			"label": "OfmWza_label",
			"metricDuration": "OfmWza_metricDuration",
			"error": "OfmWza_error",
			"notice": "OfmWza_notice",
			"refresh": "OfmWza_refresh",
			"root": "OfmWza_root",
			"content": "OfmWza_content",
			"metrics": "OfmWza_metrics",
			"disabled": "OfmWza_disabled"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-subagent\src\client\SubagentReadOnlyComposer.module.css.mjs
		const css = ".yTgjLW_frame{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-height:54px;color:var(--dsw-alias-label-tertiary);border-radius:14px;justify-content:center;align-items:center;gap:8px;margin:0 24px 20px;padding:10px 16px;font-size:13px;line-height:20px;display:flex}.yTgjLW_frame strong{color:var(--dsw-alias-label-primary);font-weight:510}";
		...
		var SubagentReadOnlyComposer_module_css_default = { "frame": "yTgjLW_frame" };
		//#endregion
