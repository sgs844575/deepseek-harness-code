window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-model-selection\src\client\ModelSelect.module.css.mjs
		const css = ".m5fuOa_root{min-width:0;position:relative}.m5fuOa_trigger{min-width:0;max-width:220px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:24px;outline:none;align-items:center;gap:4px;padding:0 4px 0 8px;font-size:13px;font-weight:500;line-height:20px;display:flex}.m5fuOa_trigger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.m5fuOa_trigger:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3)}.m5fuOa_trigger:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.m5fuOa_triggerLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.m5fuOa_triggerEffort{color:var(--dsw-alias-label-caption);flex:none}.m5fuOa_chevron{color:var(--dsw-alias-label-caption);flex:none;transition:transform .12s}.m5fuOa_chevronOpen{transform:rotate(180deg)}.m5fuOa_menu{z-index:20;border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);width:min(240px,100vw - 32px);max-height:min(360px,100vh - 96px);box-shadow:var(--dsw-shadow-lv3);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 8px);right:0;overflow:hidden}.m5fuOa_status,.m5fuOa_empty{color:var(--dsw-alias-label-tertiary);padding:10px;font-size:13px;line-height:20px}.m5fuOa_error,.m5fuOa_warning{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary);border-radius:8px;justify-content:space-between;align-items:flex-start;gap:8px;margin-bottom:4px;padding:7px 8px;font-size:12px;line-height:18px;display:flex}.m5fuOa_warning{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-state-warn-label)}.m5fuOa_retry{color:inherit;font:inherit;cursor:pointer;background:0 0;border:none;flex:none;padding:0;font-weight:600}.m5fuOa_groups{min-height:0;overflow-y:auto}.m5fuOa_group+.m5fuOa_group{margin-top:4px}.m5fuOa_groupTitle{z-index:1;background:var(--dsw-specific-menu);color:var(--dsw-alias-label-tertiary);padding:5px 8px 3px;font-size:12px;font-weight:500;line-height:18px;position:sticky;top:0}.m5fuOa_option{width:100%;min-height:38px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:none;border-radius:10px;outline:none;align-items:center;gap:8px;padding:6px 8px;display:flex}.m5fuOa_option:hover:not(:disabled),.m5fuOa_option:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.m5fuOa_selected{background:0 0}.m5fuOa_option:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.m5fuOa_optionCopy{flex-direction:column;flex:1;min-width:0;display:flex}.m5fuOa_modelName{color:inherit;text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}.m5fuOa_description{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.m5fuOa_check{color:var(--dsw-alias-label-primary);flex:0 0 18px;place-items:center;display:grid}.m5fuOa_cell{width:100%;height:40px;color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:0 10px;font-size:14px;line-height:22px;display:flex}.m5fuOa_cell:hover{background:var(--dsw-alias-interactive-bg-hover)}.m5fuOa_cellLabel{text-overflow:ellipsis;white-space:nowrap;flex:auto;min-width:0;overflow:hidden}.m5fuOa_cellValue{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:0 auto;overflow:hidden}.m5fuOa_cellChevron{color:var(--dsw-alias-label-tertiary);flex:none}";
		...
		var ModelSelect_module_css_default = {
			"option": "m5fuOa_option",
			"empty": "m5fuOa_empty",
			"selected": "m5fuOa_selected",
			"cell": "m5fuOa_cell",
			"chevron": "m5fuOa_chevron",
			"menu": "m5fuOa_menu",
			"optionCopy": "m5fuOa_optionCopy",
			"chevronOpen": "m5fuOa_chevronOpen",
			"warning": "m5fuOa_warning",
			"retry": "m5fuOa_retry",
			"description": "m5fuOa_description",
			"root": "m5fuOa_root",
			"cellLabel": "m5fuOa_cellLabel",
			"cellChevron": "m5fuOa_cellChevron",
			"triggerEffort": "m5fuOa_triggerEffort",
			"modelName": "m5fuOa_modelName",
			"status": "m5fuOa_status",
			"group": "m5fuOa_group",
			"cellValue": "m5fuOa_cellValue",
			"groupTitle": "m5fuOa_groupTitle",
			"groups": "m5fuOa_groups",
			"check": "m5fuOa_check",
			"error": "m5fuOa_error",
			"trigger": "m5fuOa_trigger",
			"triggerLabel": "m5fuOa_triggerLabel"
		};
		//#endregion
