window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-agent-preset\src\client\AgentPresetLabel.module.css.mjs
		const css$3 = "._8vpnTW_label{background:var(--dsw-alias-fill-tsp-secondary);max-width:180px;height:22px;color:var(--dsw-alias-label-secondary);white-space:nowrap;text-overflow:ellipsis;border-radius:6px;align-items:center;gap:4px;padding:0 2px 0 0;font-size:12px;line-height:22px;display:inline-flex;overflow:hidden}._8vpnTW_icon{opacity:.7;flex:none}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-agent-preset\src\client\AgentPresetRow.module.css.mjs
		const css$2 = ".E_-QXG_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.E_-QXG_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.E_-QXG_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.E_-QXG_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.E_-QXG_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.E_-QXG_selector:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.E_-QXG_selector:disabled{cursor:default}.E_-QXG_chevron{flex:none}";
		...
		var AgentPresetRow_module_css_default = {
			"desc": "E_-QXG_desc",
			"chevron": "E_-QXG_chevron",
			"title": "E_-QXG_title",
			"rowText": "E_-QXG_rowText",
			"row": "E_-QXG_row",
			"selector": "E_-QXG_selector"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-agent-preset\src\client\AgentPresetSeat.module.css.mjs
		const css$1 = ".-MR4FW_seat{max-width:min(100%,240px);min-height:28px;color:var(--dsw-alias-label-primary);white-space:nowrap;text-overflow:ellipsis;cursor:pointer;background:0 0;border:none;border-radius:16px;align-items:center;gap:4px;padding:0 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex;overflow:hidden}.-MR4FW_seat:not(:disabled):hover,.-MR4FW_seat[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover)}.-MR4FW_seat:disabled{cursor:default;color:var(--dsw-alias-label-quaternary)}.-MR4FW_seatIcon{color:var(--dsw-alias-label-primary);flex:none}.-MR4FW_introIcon{animation:.15s cubic-bezier(.16,1,.3,1) both -MR4FW_seat-icon-in}@keyframes -MR4FW_seat-icon-in{0%{opacity:0;transform:scale(.5)}to{opacity:1;transform:scale(1)}}.-MR4FW_introText{white-space:pre;display:inline-block}.-MR4FW_introChar{white-space:pre;opacity:0;animation:.4s ease-out forwards -MR4FW_seat-char-in;display:inline-block}@keyframes -MR4FW_seat-char-in{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:none}}@media (prefers-reduced-motion:reduce){.-MR4FW_introIcon,.-MR4FW_introChar{opacity:1;animation:none}}.-MR4FW_chevron{color:var(--dsw-alias-label-caption);flex:none}.-MR4FW_item{flex-direction:column;gap:2px;max-width:280px;display:flex}.-MR4FW_itemName{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}.-MR4FW_itemDesc{color:var(--dsw-alias-label-caption);white-space:normal;font-size:12px;line-height:16px}";
		...
		var AgentPresetSeat_module_css_default = {
			"item": "-MR4FW_item",
			"itemName": "-MR4FW_itemName",
			"seatIcon": "-MR4FW_seatIcon",
			"introIcon": "-MR4FW_introIcon",
			"itemDesc": "-MR4FW_itemDesc",
			"seat-char-in": "-MR4FW_seat-char-in",
			"seat-icon-in": "-MR4FW_seat-icon-in",
			"introChar": "-MR4FW_introChar",
			"seat": "-MR4FW_seat",
			"chevron": "-MR4FW_chevron",
			"introText": "-MR4FW_introText"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\client\ui-agent-preset\src\client\AgentPresetSection.module.css.mjs
		const css = ".mP07vW_section{max-width:720px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.mP07vW_title{margin:0;font-size:18px;font-weight:600}.mP07vW_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.mP07vW_group{flex-direction:column;gap:10px;display:flex}.mP07vW_group+.mP07vW_group{margin-top:20px}.mP07vW_groupHead{letter-spacing:.06em;text-transform:uppercase;color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;font-weight:600}.mP07vW_cards{grid-template-columns:repeat(auto-fill,minmax(268px,1fr));grid-auto-rows:1fr;gap:12px;margin:0;padding:0;list-style:none;display:grid}.mP07vW_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;transition:border-color .16s,background .16s;display:flex}.mP07vW_card:hover:not(.mP07vW_cardActive){border-color:var(--dsw-alias-label-dimmed)}.mP07vW_cardActive{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-primary)}.mP07vW_cardBroken,.mP07vW_cardBroken:hover{border-color:var(--dsw-alias-state-error-primary)}.mP07vW_brokenBadge{white-space:nowrap;background:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-bg-layer-3);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.mP07vW_cardBrokenReason{color:var(--dsw-alias-state-error-primary);overflow-wrap:anywhere;font-size:12px;line-height:1.5}.mP07vW_cardMain{appearance:none;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px 12px 0 0;flex-direction:column;flex:1;gap:8px;padding:14px 16px 12px;display:flex}.mP07vW_cardMain:disabled{cursor:default}.mP07vW_cardMain:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.mP07vW_cardHead{align-items:center;gap:8px;display:flex}.mP07vW_cardName{font-size:15px;font-weight:600;line-height:1.4}.mP07vW_badge,.mP07vW_inUse{white-space:nowrap;border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.mP07vW_badge{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-tertiary)}.mP07vW_inUse{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);margin-left:auto}.mP07vW_cardDesc{color:var(--dsw-alias-label-secondary);-webkit-line-clamp:4;overflow-wrap:anywhere;-webkit-box-orient:vertical;min-height:42px;font-size:13px;line-height:1.55;display:-webkit-box;overflow:hidden}.mP07vW_cardId{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-dimmed);margin-top:auto;font-size:11px}.mP07vW_cardFoot{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;gap:2px;padding:6px 10px;display:flex}.mP07vW_iconButton{appearance:none;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;align-items:center;padding:6px;display:inline-flex;position:relative}.mP07vW_iconButton:disabled{opacity:.4;cursor:default}.mP07vW_iconButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary)}.mP07vW_iconButton:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-1px}.mP07vW_iconButton:after{content:attr(data-tip);background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);white-space:nowrap;opacity:0;pointer-events:none;border-radius:6px;padding:3px 8px;font-size:11px;line-height:17px;transition:opacity .12s;position:absolute;bottom:calc(100% + 6px);left:50%;transform:translate(-50%)}.mP07vW_iconButton:hover:after,.mP07vW_iconButton:focus-visible:after{opacity:1}.mP07vW_iconDanger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.mP07vW_revealedPath{color:var(--dsw-alias-label-tertiary);align-items:baseline;gap:6px;margin:0;padding:6px 16px 10px;font-size:11px;display:flex}.mP07vW_revealedPath code{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-secondary);user-select:all;overflow-wrap:anywhere}.mP07vW_revealedPathLabel{white-space:nowrap}.mP07vW_secondaryButton{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:7px;padding:5px 8px;font-size:12.5px}.mP07vW_secondaryButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1)}.mP07vW_secondaryButton:disabled{opacity:.5;cursor:default}.mP07vW_field{flex-direction:column;gap:6px;display:flex}.mP07vW_fieldLabel{color:var(--dsw-alias-label-secondary);font-size:12px;font-weight:500}.mP07vW_input{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);font:inherit;background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);border-radius:10px;padding:9px 12px;font-size:13px}.mP07vW_input:focus{border-color:var(--dsw-alias-brand-primary);outline:none}.mP07vW_input::placeholder{color:var(--dsw-alias-label-dimmed)}.mP07vW_dialog{width:min(560px,100%)}.mP07vW_dialogFields{flex-direction:column;gap:12px;display:flex}.mP07vW_viewerCode{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);max-height:min(52vh,480px);color:var(--dsw-alias-label-secondary);font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);white-space:pre;tab-size:2;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:10px;margin:0;padding:12px;font-size:12.5px;line-height:1.5;overflow:auto}.mP07vW_error{color:var(--dsw-alias-state-error-primary);margin:0;font-size:12px}.mP07vW_deleteDialog{width:min(480px,100%)}.mP07vW_deleteConfirm:not(:disabled){border-color:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-state-error-primary)}.mP07vW_deleteConfirm:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger)}.mP07vW_creatorButton{box-sizing:border-box;border:1px dashed var(--dsw-alias-border-l3);height:44px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:12px;justify-content:center;align-self:stretch;align-items:center;gap:6px;font-size:14px;line-height:22px;display:flex}.mP07vW_creatorButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.mP07vW_creatorButton:disabled{opacity:.4;cursor:default}";
		...
		var AgentPresetSection_module_css_default = {
			"cards": "mP07vW_cards",
			"groupHead": "mP07vW_groupHead",
			"error": "mP07vW_error",
			"viewerCode": "mP07vW_viewerCode",
			"deleteDialog": "mP07vW_deleteDialog",
			"brokenBadge": "mP07vW_brokenBadge",
			"cardBrokenReason": "mP07vW_cardBrokenReason",
			"intro": "mP07vW_intro",
			"inUse": "mP07vW_inUse",
			"revealedPathLabel": "mP07vW_revealedPathLabel",
			"cardDesc": "mP07vW_cardDesc",
			"iconButton": "mP07vW_iconButton",
			"input": "mP07vW_input",
			"iconDanger": "mP07vW_iconDanger",
			"field": "mP07vW_field",
			"cardHead": "mP07vW_cardHead",
			"cardFoot": "mP07vW_cardFoot",
			"cardBroken": "mP07vW_cardBroken",
			"cardName": "mP07vW_cardName",
			"fieldLabel": "mP07vW_fieldLabel",
			"dialogFields": "mP07vW_dialogFields",
			"card": "mP07vW_card",
			"cardActive": "mP07vW_cardActive",
			"cardId": "mP07vW_cardId",
			"dialog": "mP07vW_dialog",
			"title": "mP07vW_title",
			"secondaryButton": "mP07vW_secondaryButton",
			"revealedPath": "mP07vW_revealedPath",
			"section": "mP07vW_section",
			"creatorButton": "mP07vW_creatorButton",
			"deleteConfirm": "mP07vW_deleteConfirm",
			"badge": "mP07vW_badge",
			"cardMain": "mP07vW_cardMain",
			"group": "mP07vW_group"
		};
		//#endregion
