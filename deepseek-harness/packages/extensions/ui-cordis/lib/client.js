window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\extensions\ui-cordis\src\client\CordisRunRow.module.css.mjs
		const css$2 = ".wDZJuq_card{flex-direction:column;gap:8px;display:flex}.wDZJuq_row{align-items:center;min-height:32px;display:flex}.wDZJuq_icon{color:var(--dsw-alias-state-business-primary);flex:none;margin-right:8px;display:inline-flex}.wDZJuq_title{color:var(--dsw-alias-state-business-primary);flex:none;font-size:14px;font-weight:500;line-height:24px}.wDZJuq_separator{background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:2px;height:2px;margin:0 8px}.wDZJuq_summary,.wDZJuq_error{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:24px;overflow:hidden}.wDZJuq_error{color:var(--dsw-alias-state-error-primary)}.wDZJuq_status{color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px}.wDZJuq_card[data-cordis-status=awaiting-approval] .wDZJuq_status,.wDZJuq_card[data-cordis-status=client-pending] .wDZJuq_status{color:var(--dsw-alias-state-warn-label)}.wDZJuq_card[data-cordis-status=running] .wDZJuq_status{color:var(--dsw-alias-state-success-primary)}.wDZJuq_card[data-cordis-status=failed] .wDZJuq_status{color:var(--dsw-alias-state-error-primary)}.wDZJuq_inspect{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;opacity:0;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;margin-left:4px;padding:0;display:inline-flex}.wDZJuq_card:hover .wDZJuq_inspect,.wDZJuq_inspect:focus-visible{opacity:1}.wDZJuq_inspect:hover{background:var(--dsw-alias-interactive-bg-hover)}.wDZJuq_message{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-tertiary);border-radius:8px;padding:8px 12px;font-size:12px;line-height:18px}.wDZJuq_business{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;min-width:0;overflow:hidden}.wDZJuq_output{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;overflow-wrap:anywhere;border-radius:8px;margin:0;padding:10px 12px;overflow:auto}.wDZJuq_business .wDZJuq_output{border:none;border-radius:0}";
		...
		var CordisRunRow_module_css_default = {
			"card": "wDZJuq_card",
			"summary": "wDZJuq_summary",
			"error": "wDZJuq_error",
			"row": "wDZJuq_row",
			"output": "wDZJuq_output",
			"icon": "wDZJuq_icon",
			"business": "wDZJuq_business",
			"inspect": "wDZJuq_inspect",
			"title": "wDZJuq_title",
			"separator": "wDZJuq_separator",
			"status": "wDZJuq_status",
			"message": "wDZJuq_message"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\extensions\ui-cordis\src\client\CordisDefineRow.module.css.mjs
		const css$1 = "._iukaW_card{flex-direction:column;display:flex}._iukaW_card ._iukaW_title,._iukaW_card ._iukaW_chevron{color:var(--dsw-alias-state-business-primary)}._iukaW_title{flex:none;font-size:14px;font-weight:500;line-height:24px}._iukaW_row{gap:0}._iukaW_separator{background:var(--dsw-alias-state-business-primary);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}._iukaW_name{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px;overflow:hidden}._iukaW_purpose{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;margin-left:8px;font-size:13px;line-height:24px;overflow:hidden}._iukaW_errorSummary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-state-error-primary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}._iukaW_requestError{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-state-error-primary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}._iukaW_readout{flex:none;align-items:center;margin-left:8px;display:inline-flex}._iukaW_panelHint{color:var(--dsw-alias-label-caption);margin:4px 0 2px 4px;font-size:11px;line-height:16px}._iukaW_statusLabel{color:var(--dsw-alias-label-caption);font-size:12px;line-height:24px}._iukaW_approvalPrompt{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}._iukaW_notice{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}._iukaW_switch{height:22px;padding:0 8px;font-size:12px}._iukaW_card[data-terminal] ._iukaW_title,._iukaW_card[data-terminal] ._iukaW_name,._iukaW_card[data-terminal] ._iukaW_purpose,._iukaW_card[data-terminal] ._iukaW_statusLabel{color:var(--dsw-alias-label-caption)}._iukaW_card[data-terminal] ._iukaW_separator{background:var(--dsw-alias-label-caption)}._iukaW_bodyWrap{flex-direction:column;display:flex}._iukaW_sourceCard{flex-direction:column;margin:4px 0 4px 4px;display:flex}._iukaW_sourceTabs{border-bottom:1px solid var(--dsw-alias-border-l2);height:32px;display:flex}._iukaW_sourceTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;padding:0 10px;position:relative}._iukaW_sourceTab:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._iukaW_sourceTab:disabled{cursor:default;opacity:.4}._iukaW_sourceTabActive{color:var(--dsw-alias-state-business-primary)}._iukaW_sourceTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:10px;right:10px}._iukaW_sourceTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}._iukaW_sourcePanel{max-height:260px;overflow:auto}._iukaW_sourceCode{margin:0}._iukaW_codeSection{flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:auto}._iukaW_sectionLabel{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:2px 0;font-size:11px;font-weight:500;line-height:16px}._iukaW_output{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);border-radius:8px;margin:0;padding:8px 10px}._iukaW_output[data-error]{color:var(--dsw-alias-state-error-primary)}._iukaW_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}._iukaW_card:hover ._iukaW_inspectButton,._iukaW_inspectButton:focus-visible{opacity:1}._iukaW_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}._iukaW_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){._iukaW_inspectButton{transition:none}}";
		...
		var CordisDefineRow_module_css_default = {
			"name": "_iukaW_name",
			"notice": "_iukaW_notice",
			"bodyWrap": "_iukaW_bodyWrap",
			"title": "_iukaW_title",
			"separator": "_iukaW_separator",
			"readout": "_iukaW_readout",
			"chevron": "_iukaW_chevron",
			"card": "_iukaW_card",
			"errorSummary": "_iukaW_errorSummary",
			"panelHint": "_iukaW_panelHint",
			"sourceTabs": "_iukaW_sourceTabs",
			"sourcePanel": "_iukaW_sourcePanel",
			"switch": "_iukaW_switch",
			"row": "_iukaW_row",
			"requestError": "_iukaW_requestError",
			"sourceTab": "_iukaW_sourceTab",
			"codeSection": "_iukaW_codeSection",
			"sectionLabel": "_iukaW_sectionLabel",
			"output": "_iukaW_output",
			"sourceCode": "_iukaW_sourceCode",
			"inspectButton": "_iukaW_inspectButton",
			"visuallyHidden": "_iukaW_visuallyHidden",
			"sourceCard": "_iukaW_sourceCard",
			"purpose": "_iukaW_purpose",
			"approvalPrompt": "_iukaW_approvalPrompt",
			"sourceTabActive": "_iukaW_sourceTabActive",
			"statusLabel": "_iukaW_statusLabel"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Projects\AiProjects\DeepSeekHarnessIdea\deepseek-harness\packages\extensions\ui-cordis\src\client\CordisPanel.module.css.mjs
		const css = ".eLYZra_layer{flex:none;align-items:center;width:100%;height:49px;margin:8px 0 0;display:flex;position:relative}.eLYZra_footerButtons{align-items:center;width:100%;display:flex}.eLYZra_badge{width:100%;height:49px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;padding:0 8px 0 6px;font-family:inherit;font-size:14px;display:inline-flex;overflow:hidden}.eLYZra_badge:hover{background:var(--dsw-alias-interactive-bg-hover-solid)}.eLYZra_badge[data-active]{background:var(--dsw-alias-interactive-bg-hover)}.eLYZra_badgeLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.eLYZra_badgeCount{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex:none;margin-left:auto;font-size:12px;line-height:16px}.eLYZra_layer.eLYZra_rail{width:36px;height:36px;margin:0}.eLYZra_rail .eLYZra_badge{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;padding:0}.eLYZra_rail .eLYZra_footerButtons{flex-direction:column;gap:2px}.eLYZra_panel{z-index:30;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-base);width:420px;max-width:calc(100vw - 24px);max-height:60vh;box-shadow:var(--dsw-shadow-lv2);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;display:flex;position:fixed;bottom:128px;left:12px;overflow:hidden}.eLYZra_header{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:10px 12px;display:flex}.eLYZra_body{flex:1;min-height:0;padding:4px 12px 12px;overflow-y:auto}.eLYZra_title{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:500;line-height:20px}.eLYZra_note,.eLYZra_readError{color:var(--dsw-alias-label-tertiary);margin:4px 0;font-size:12px;line-height:18px}.eLYZra_readError{color:var(--dsw-alias-state-error-primary)}.eLYZra_group{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;margin:8px 0 4px;font-size:11px;font-weight:500;line-height:16px}.eLYZra_rows{flex-direction:column;gap:8px;margin:0;padding:0;list-style:none;display:flex}.eLYZra_row{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;flex-direction:column;gap:8px;padding:10px 12px;display:flex}.eLYZra_row[data-cordis-awaiting]{border-color:var(--dsw-alias-state-business-primary)}.eLYZra_rowHead{align-items:center;gap:8px;display:flex}.eLYZra_rowId{color:var(--dsw-alias-label-tertiary);font-family:var(--dsh-font-mono,monospace);flex:none;font-size:11px;line-height:20px}.eLYZra_rowName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.eLYZra_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);height:20px;color:var(--dsw-alias-label-caption);border-radius:10px;flex:none;align-items:center;padding:0 6px;font-size:11px;line-height:20px;display:inline-flex}.eLYZra_row[data-cordis-status=idle] .eLYZra_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-caption)}.eLYZra_row[data-cordis-status=awaiting-approval] .eLYZra_rowStatus,.eLYZra_row[data-cordis-status=client-pending] .eLYZra_rowStatus{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-label)}.eLYZra_row[data-cordis-status=failed] .eLYZra_rowStatus{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.eLYZra_row[data-cordis-status=running] .eLYZra_rowStatus{background:var(--dsw-alias-state-success-tertiary);color:var(--dsw-alias-state-success-primary)}.eLYZra_rowDetail{align-items:center;gap:8px;min-height:28px;display:flex}.eLYZra_versionPicker{color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.eLYZra_versionPicker select{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);min-width:0;height:26px;color:var(--dsw-alias-label-secondary);font:inherit;border-radius:7px;flex:1;padding:0 8px}.eLYZra_rowPurpose{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:18px;overflow:hidden}.eLYZra_rowError{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}.eLYZra_rowActions{flex:none;align-items:center;gap:10px;display:flex}.eLYZra_transition{min-width:0;color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.eLYZra_transitionActions{gap:6px;margin-left:auto;display:flex}.eLYZra_transitionActions button{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border-radius:999px;padding:2px 8px}.eLYZra_transitionActions button:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.eLYZra_transitionActions button:disabled{opacity:.4;cursor:default}.eLYZra_activeVersion{color:var(--dsw-alias-label-caption);font-size:11px;line-height:16px}.eLYZra_actionButton{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;padding:0;display:inline-flex}.eLYZra_actionButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.eLYZra_actionButton:disabled{opacity:.4;cursor:default}.eLYZra_doubleCheck{width:17px;height:14px;display:inline-block;position:relative}.eLYZra_doubleCheck svg{position:absolute;top:1px}.eLYZra_doubleCheck svg:first-child{opacity:.7;left:0}.eLYZra_doubleCheck svg:last-child{left:5px}";
		...
		var CordisPanel_module_css_default = {
			"readError": "eLYZra_readError",
			"actionButton": "eLYZra_actionButton",
			"rowError": "eLYZra_rowError",
			"badgeLabel": "eLYZra_badgeLabel",
			"group": "eLYZra_group",
			"rowHead": "eLYZra_rowHead",
			"body": "eLYZra_body",
			"panel": "eLYZra_panel",
			"title": "eLYZra_title",
			"rowActions": "eLYZra_rowActions",
			"rowDetail": "eLYZra_rowDetail",
			"versionPicker": "eLYZra_versionPicker",
			"footerButtons": "eLYZra_footerButtons",
			"rowStatus": "eLYZra_rowStatus",
			"layer": "eLYZra_layer",
			"rowPurpose": "eLYZra_rowPurpose",
			"activeVersion": "eLYZra_activeVersion",
			"rail": "eLYZra_rail",
			"rowName": "eLYZra_rowName",
			"header": "eLYZra_header",
			"rowId": "eLYZra_rowId",
			"transition": "eLYZra_transition",
			"doubleCheck": "eLYZra_doubleCheck",
			"badge": "eLYZra_badge",
			"badgeCount": "eLYZra_badgeCount",
			"rows": "eLYZra_rows",
			"transitionActions": "eLYZra_transitionActions",
			"note": "eLYZra_note",
			"row": "eLYZra_row"
		};
		//#endregion
