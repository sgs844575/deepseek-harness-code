window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region src/client/evaluator.ts
		/**
...
call: (method, args = null) => env.invoke(method, args) }, harnessTrap(), ...Object.values(traps), void 0, void 0);
		...
		*/
		...
		//#endregion
		//#region src/client/inspect-registry.ts
		...
		*/
		...
		//#endregion
		//#region src/client/api-catalog.ts
		...
		*/
		...
		//#endregion
		//#region src/client/slot-catalog.ts
		...
		//#endregion
		//#region src/client/providers.ts
		const EMPTY_INPUT = {
			type: "object",
			properties: {},
